...
`)}var yx={[Ac]:"Linear",[Rc]:"Reinhard",[Cc]:"Cineon",[Ic]:"ACESFilmic",[Lc]:"AgX",[Dc]:"Neutral",[Pc]:"Custom"};function Mx(n,e){let t=yx[e];return t===void 0?(Ne("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var ol=new D;function Sx(){et.getLuminanceCoefficients(ol);let n=ol.x.toFixed(4),e=ol.y.toFixed(4),t=ol.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);let E=M+m+a,S=M+p+o,I=Gd(s,s.VERTEX_SHADER,E),T=Gd(s,s.FRAGMENT_SHADER,S);s.attachShader(y,I),s.attachShader(y,T),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function L(R){if(n.debug.checkShaderErrors){let B=s.getProgramInfoLog(y)||"",G=s.getShaderInfoLog(I)||"",W=s.getShaderInfoLog(T)||"",w=B.trim(),P=G.trim(),F=W.trim(),Y=!0,K=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(Y=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,y,I,T);else{let ne=Xd(s,I,"vertex"),pe=Xd(s,T,"fragment");Oe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`,tv=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],nv=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],Qd=new xt,qr=new D,ah=new D;function iv(n,e,t){let i=new Ns,s=new ue,r=new ue,a=new yt,o=new Qa,l=new eo,c={},u=t.maxTextureSize,d={[ei]:Nt,[Nt]:ei,[Xt]:Xt},h=new dn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ue},radius:{value:4}},vertexShader:Qx,fragmentShader:ev}),f=h.clone();f.defines.HORIZONTAL_PASS=1;let g=new zt;g.setAttribute("position",new cn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let y=new _e(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Fr;let p=this.type;this.render=function(T,L,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;this.type===Xu&&(Ne("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Fr);let A=n.getRenderTarget(),U=n.getActiveCubeFace(),R=n.getActiveMipmapLevel(),B=n.state;B.setBlending(Vn),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);let G=p!==this.type;G&&L.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(w=>w.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,w=T.length;W<w;W++){let P=T[W],F=P.shadow;if(F===void 0){Ne("WebGLShadowMap:",P,"has no shadow.");continue}if(F.autoUpdate===!1&&F.needsUpdate===!1)continue;s.copy(F.mapSize);let Y=F.getFrameExtents();s.multiply(Y),r.copy(F.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/Y.x),s.x=r.x*Y.x,F.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/Y.y),s.y=r.y*Y.y,F.mapSize.y=r.y));let K=n.state.buffers.depth.getReversed();if(F.camera._reversedDepth=K,F.map===null||G===!0){if(F.map!==null&&(F.map.depthTexture!==null&&(F.map.depthTexture.dispose(),F.map.depthTexture=null),F.map.dispose()),this.type===Hs){if(P.isPointLight){Ne("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}F.map=new hn(s.x,s.y,{format:Ri,type:Gn,minFilter:Bt,magFilter:Bt,generateMipmaps:!1}),F.map.texture.name=P.name+".shadowMap",F.map.depthTexture=new ni(s.x,s.y,Rn),F.map.depthTexture.name=P.name+".shadowMapDepth",F.map.depthTexture.format=zn,F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=Ct,F.map.depthTexture.magFilter=Ct}else P.isPointLight?(F.map=new cl(s.x),F.map.depthTexture=new qa(s.x,An)):(F.map=new hn(s.x,s.y),F.map.depthTexture=new ni(s.x,s.y,An)),F.map.depthTexture.name=P.name+".shadowMap",F.map.depthTexture.format=zn,this.type===Fr?(F.map.depthTexture.compareFunction=K?rl:sl,F.map.depthTexture.minFilter=Bt,F.map.depthTexture.magFilter=Bt):(F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=Ct,F.map.depthTexture.magFilter=Ct);F.camera.updateProjectionMatrix()}let ne=F.map.isWebGLCubeRenderTarget?6:1;for(let pe=0;pe<ne;pe++){if(F.map.isWebGLCubeRenderTarget)n.setRenderTarget(F.map,pe),n.clear();else{pe===0&&(n.setRenderTarget(F.map),n.clear());let ge=F.getViewport(pe);a.set(r.x*ge.x,r.y*ge.y,r.x*ge.z,r.y*ge.w),B.viewport(a)}if(P.isPointLight){let ge=F.camera,Be=F.matrix,je=P.distance||ge.far;je!==ge.far&&(ge.far=je,ge.updateProjectionMatrix()),qr.setFromMatrixPosition(P.matrixWorld),ge.position.copy(qr),ah.copy(ge.position),ah.add(tv[pe]),ge.up.copy(nv[pe]),ge.lookAt(ah),ge.updateMatrixWorld(),Be.makeTranslation(-qr.x,-qr.y,-qr.z),Qd.multiplyMatrices(ge.projectionMatrix,ge.matrixWorldInverse),F._frustum.setFromProjectionMatrix(Qd,ge.coordinateSystem,ge.reversedDepth)}else F.updateMatrices(P);i=F.getFrustum(),S(L,x,F.camera,P,this.type)}F.isPointLightShadow!==!0&&this.type===Hs&&M(F,x),F.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(A,U,R)};function M(T,L){let x=e.update(y);h.defines.VSM_SAMPLES!==T.blurSamples&&(h.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new hn(s.x,s.y,{format:Ri,type:Gn})),h.uniforms.shadow_pass.value=T.map.depthTexture,h.uniforms.resolution.value=T.mapSize,h.uniforms.radius.value=T.radius,n.setRenderTarget(T.mapPass),n.clear(),n.renderBufferDirect(L,null,x,h,y,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,n.setRenderTarget(T.map),n.clear(),n.renderBufferDirect(L,null,x,f,y,null)}function E(T,L,x,A){let U=null,R=x.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(R!==void 0)U=R;else if(U=x.isPointLight===!0?l:o,n.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0||L.alphaToCoverage===!0){let B=U.uuid,G=L.uuid,W=c[B];W===void 0&&(W={},c[B]=W);let w=W[G];w===void 0&&(w=U.clone(),W[G]=w,L.addEventListener("dispose",I)),U=w}if(U.visible=L.visible,U.wireframe=L.wireframe,A===Hs?U.side=L.shadowSide!==null?L.shadowSide:L.side:U.side=L.shadowSide!==null?L.shadowSide:d[L.side],U.alphaMap=L.alphaMap,U.alphaTest=L.alphaToCoverage===!0?.5:L.alphaTest,U.map=L.map,U.clipShadows=L.clipShadows,U.clippingPlanes=L.clippingPlanes,U.clipIntersection=L.clipIntersection,U.displacementMap=L.displacementMap,U.displacementScale=L.displacementScale,U.displacementBias=L.displacementBias,U.wireframeLinewidth=L.wireframeLinewidth,U.linewidth=L.linewidth,x.isPointLight===!0&&U.isMeshDistanceMaterial===!0){let B=n.properties.get(U);B.light=x}return U}function S(T,L,x,A,U){if(T.visible===!1)return;if(T.layers.test(L.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&U===Hs)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,T.matrixWorld);let G=e.update(T),W=T.material;if(Array.isArray(W)){let w=G.groups;for(let P=0,F=w.length;P<F;P++){let Y=w[P],K=W[Y.materialIndex];if(K&&K.visible){let ne=E(T,K,A,U);T.onBeforeShadow(n,T,L,x,G,ne,Y),n.renderBufferDirect(x,null,G,ne,T,Y),T.onAfterShadow(n,T,L,x,G,ne,Y)}}}else if(W.visible){let w=E(T,W,A,U);T.onBeforeShadow(n,T,L,x,G,w,null),n.renderBufferDirect(x,null,G,w,T,null),T.onAfterShadow(n,T,L,x,G,w,null)}}let B=T.children;for(let G=0,W=B.length;G<W;G++)S(B[G],L,x,A,U)}function I(T){T.target.removeEventListener("dispose",I);for(let x in c){let A=c[x],U=T.target.uuid;U in A&&(A[U].dispose(),delete A[U])}}}function sv(n,e){function t(){let N=!1,ce=new yt,Z=null,be=new yt(0,0,0,0);return{setMask:function(fe){Z!==fe&&!N&&(n.colorMask(fe,fe,fe,fe),Z=fe)},setLocked:function(fe){N=fe},setClear:function(fe,te,Ie,Ye,wt){wt===!0&&(fe*=Ye,te*=Ye,Ie*=Ye),ce.set(fe,te,Ie,Ye),be.equals(ce)===!1&&(n.clearColor(fe,te,Ie,Ye),be.copy(ce))},reset:function(){N=!1,Z=null,be.set(-1,0,0,0)}}}function i(){let N=!1,ce=!1,Z=null,be=null,fe=null;return{setReversed:function(te){if(ce!==te){let Ie=e.get("EXT_clip_control");te?Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.ZERO_TO_ONE_EXT):Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.NEGATIVE_ONE_TO_ONE_EXT),ce=te;let Ye=fe;fe=null,this.setClear(Ye)}},getReversed:function(){return ce},setTest:function(te){te?ie(n.DEPTH_TEST):Ae(n.DEPTH_TEST)},setMask:function(te){Z!==te&&!N&&(n.depthMask(te),Z=te)},setFunc:function(te){if(ce&&(te=Ed[te]),be!==te){switch(te){case La:n.depthFunc(n.NEVER);break;case Da:n.depthFunc(n.ALWAYS);break;case Na:n.depthFunc(n.LESS);break;case Xi:n.depthFunc(n.LEQUAL);break;case Ua:n.depthFunc(n.EQUAL);break;case Fa:n.depthFunc(n.GEQUAL);break;case Oa:n.depthFunc(n.GREATER);break;case Ba:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}be=te}},setLocked:function(te){N=te},setClear:function(te){fe!==te&&(fe=te,ce&&(te=1-te),n.clearDepth(te))},reset:function(){N=!1,Z=null,be=null,fe=null,ce=!1}}}function s(){let N=!1,ce=null,Z=null,be=null,fe=null,te=null,Ie=null,Ye=null,wt=null;return{setTest:function(ut){N||(ut?ie(n.STENCIL_TEST):Ae(n.STENCIL_TEST))},setMask:function(ut){ce!==ut&&!N&&(n.stencilMask(ut),ce=ut)},setFunc:function(ut,Yn,Nn){(Z!==ut||be!==Yn||fe!==Nn)&&(n.stencilFunc(ut,Yn,Nn),Z=ut,be=Yn,fe=Nn)},setOp:function(ut,Yn,Nn){(te!==ut||Ie!==Yn||Ye!==Nn)&&(n.stencilOp(ut,Yn,Nn),te=ut,Ie=Yn,Ye=Nn)},setLocked:function(ut){N=ut},setClear:function(ut){wt!==ut&&(n.clearStencil(ut),wt=ut)},reset:function(){N=!1,ce=null,Z=null,be=null,fe=null,te=null,Ie=null,Ye=null,wt=null}}}let r=new t,a=new i,o=new s,l=new WeakMap,c=new WeakMap,u={},d={},h={},f=new WeakMap,g=[],y=null,m=!1,p=null,M=null,E=null,S=null,I=null,T=null,L=null,x=new qe(0,0,0),A=0,U=!1,R=null,B=null,G=null,W=null,w=null,P=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS),F=!1,Y=0,K=n.getParameter(n.VERSION);K.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(K)[1]),F=Y>=1):K.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),F=Y>=2);let ne=null,pe={},ge=n.getParameter(n.SCISSOR_BOX),Be=n.getParameter(n.VIEWPORT),je=new yt().fromArray(ge),ze=new yt().fromArray(Be);function q(N,ce,Z,be){let fe=new Uint8Array(4),te=n.createTexture();n.bindTexture(N,te),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ie=0;Ie<Z;Ie++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(ce,0,n.RGBA,1,1,be,0,n.RGBA,n.UNSIGNED_BYTE,fe):n.texImage2D(ce+Ie,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,fe);return te}let oe={};oe[n.TEXTURE_2D]=q(n.TEXTURE_2D,n.TEXTURE_2D,1),oe[n.TEXTURE_CUBE_MAP]=q(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),oe[n.TEXTURE_2D_ARRAY]=q(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),oe[n.TEXTURE_3D]=q(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ie(n.DEPTH_TEST),a.setFunc(Xi),ye(!1),me(Ec),ie(n.CULL_FACE),se(Vn);function ie(N){u[N]!==!0&&(n.enable(N),u[N]=!0)}function Ae(N){u[N]!==!1&&(n.disable(N),u[N]=!1)}function Fe(N,ce){return h[N]!==ce?(n.bindFramebuffer(N,ce),h[N]=ce,N===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=ce),N===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=ce),!0):!1}function De(N,ce){let Z=g,be=!1;if(N){Z=f.get(ce),Z===void 0&&(Z=[],f.set(ce,Z));let fe=N.textures;if(Z.length!==fe.length||Z[0]!==n.COLOR_ATTACHMENT0){for(let te=0,Ie=fe.length;te<Ie;te++)Z[te]=n.COLOR_ATTACHMENT0+te;Z.length=fe.length,be=!0}}else Z[0]!==n.BACK&&(Z[0]=n.BACK,be=!0);be&&n.drawBuffers(Z)}function nt(N){return y!==N?(n.useProgram(N),y=N,!0):!1}let ke={[_i]:n.FUNC_ADD,[Yu]:n.FUNC_SUBTRACT,[Zu]:n.FUNC_REVERSE_SUBTRACT};ke[Ju]=n.MIN,ke[$u]=n.MAX;let j={[Ku]:n.ZERO,[ju]:n.ONE,[Qu]:n.SRC_COLOR,[Ia]:n.SRC_ALPHA,[rd]:n.SRC_ALPHA_SATURATE,[id]:n.DST_COLOR,[td]:n.DST_ALPHA,[ed]:n.ONE_MINUS_SRC_COLOR,[Pa]:n.ONE_MINUS_SRC_ALPHA,[sd]:n.ONE_MINUS_DST_COLOR,[nd]:n.ONE_MINUS_DST_ALPHA,[ad]:n.CONSTANT_COLOR,[od]:n.ONE_MINUS_CONSTANT_COLOR,[ld]:n.CONSTANT_ALPHA,[cd]:n.ONE_MINUS_CONSTANT_ALPHA};function se(N,ce,Z,be,fe,te,Ie,Ye,wt,ut){if(N===Vn){m===!0&&(Ae(n.BLEND),m=!1);return}if(m===!1&&(ie(n.BLEND),m=!0),N!==qu){if(N!==p||ut!==U){if((M!==_i||I!==_i)&&(n.blendEquation(n.FUNC_ADD),M=_i,I=_i),ut)switch(N){case Wi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case $i:n.blendFunc(n.ONE,n.ONE);break;case Tc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case wc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Oe("WebGLState: Invalid blending: ",N);break}else switch(N){case Wi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case $i:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Tc:Oe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case wc:Oe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Oe("WebGLState: Invalid blending: ",N);break}E=null,S=null,T=null,L=null,x.set(0,0,0),A=0,p=N,U=ut}return}fe=fe||ce,te=te||Z,Ie=Ie||be,(ce!==M||fe!==I)&&(n.blendEquationSeparate(ke[ce],ke[fe]),M=ce,I=fe),(Z!==E||be!==S||te!==T||Ie!==L)&&(n.blendFuncSeparate(j[Z],j[be],j[te],j[Ie]),E=Z,S=be,T=te,L=Ie),(Ye.equals(x)===!1||wt!==A)&&(n.blendColor(Ye.r,Ye.g,Ye.b,wt),x.copy(Ye),A=wt),p=N,U=!1}function Q(N,ce){N.side===Xt?Ae(n.CULL_FACE):ie(n.CULL_FACE);let Z=N.side===Nt;ce&&(Z=!Z),ye(Z),N.blending===Wi&&N.transparent===!1?se(Vn):se(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),r.setMask(N.colorWrite);let be=N.stencilWrite;o.setTest(be),be&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),C(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?ie(n.SAMPLE_ALPHA_TO_COVERAGE):Ae(n.SAMPLE_ALPHA_TO_COVERAGE)}function ye(N){R!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),R=N)}function me(N){N!==Gu?(ie(n.CULL_FACE),N!==B&&(N===Ec?n.cullFace(n.BACK):N===Wu?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Ae(n.CULL_FACE),B=N}function He(N){N!==G&&(F&&n.lineWidth(N),G=N)}function C(N,ce,Z){N?(ie(n.POLYGON_OFFSET_FILL),(W!==ce||w!==Z)&&(W=ce,w=Z,a.getReversed()&&(ce=-ce),n.polygonOffset(ce,Z))):Ae(n.POLYGON_OFFSET_FILL)}function Ge(N){N?ie(n.SCISSOR_TEST):Ae(n.SCISSOR_TEST)}function Re(N){N===void 0&&(N=n.TEXTURE0+P-1),ne!==N&&(n.activeTexture(N),ne=N)}function Ve(N,ce,Z){Z===void 0&&(ne===null?Z=n.TEXTURE0+P-1:Z=ne);let be=pe[Z];be===void 0&&(be={type:void 0,texture:void 0},pe[Z]=be),(be.type!==N||be.texture!==ce)&&(ne!==Z&&(n.activeTexture(Z),ne=Z),n.bindTexture(N,ce||oe[N]),be.type=N,be.texture=ce)}function re(){let N=pe[ne];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function lt(){try{n.compressedTexImage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function b(){try{n.compressedTexImage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function _(){try{n.texSubImage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function z(){try{n.texSubImage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function J(){try{n.compressedTexSubImage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function ee(){try{n.compressedTexSubImage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function ae(){try{n.texStorage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function he(){try{n.texStorage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function X(){try{n.texImage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function $(){try{n.texImage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function Se(N){return d[N]!==void 0?d[N]:n.getParameter(N)}function Te(N,ce){d[N]!==ce&&(n.pixelStorei(N,ce),d[N]=ce)}function de(N){je.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),je.copy(N))}function le(N){ze.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),ze.copy(N))}function We(N,ce){let Z=c.get(ce);Z===void 0&&(Z=new WeakMap,c.set(ce,Z));let be=Z.get(N);be===void 0&&(be=n.getUniformBlockIndex(ce,N.name),Z.set(N,be))}function Je(N,ce){let be=c.get(ce).get(N);l.get(ce)!==be&&(n.uniformBlockBinding(ce,be,N.__bindingPointIndex),l.set(ce,be))}function rt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),u={},d={},ne=null,pe={},h={},f=new WeakMap,g=[],y=null,m=!1,p=null,M=null,E=null,S=null,I=null,T=null,L=null,x=new qe(0,0,0),A=0,U=!1,R=null,B=null,G=null,W=null,w=null,je.set(0,0,n.canvas.width,n.canvas.height),ze.set(0,0,n.canvas.width,n.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ie,disable:Ae,bindFramebuffer:Fe,drawBuffers:De,useProgram:nt,setBlending:se,setMaterial:Q,setFlipSided:ye,setCullFace:me,setLineWidth:He,setPolygonOffset:C,setScissorTest:Ge,activeTexture:Re,bindTexture:Ve,unbindTexture:re,compressedTexImage2D:lt,compressedTexImage3D:b,texImage2D:X,texImage3D:$,pixelStorei:Te,getParameter:Se,updateUBOMapping:We,uniformBlockBinding:Je,texStorage2D:ae,texStorage3D:he,texSubImage2D:_,texSubImage3D:z,compressedTexSubImage2D:J,compressedTexSubImage3D:ee,scissor:de,viewport:le,reset:rt}}function rv(n,e,t,i,s,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ue,u=new WeakMap,d=new Set,h,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(b,_){return g?new OffscreenCanvas(b,_):ur("canvas")}function m(b,_,z){let J=1,ee=lt(b);if((ee.width>z||ee.height>z)&&(J=z/Math.max(ee.width,ee.height)),J<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){let ae=Math.floor(J*ee.width),he=Math.floor(J*ee.height);h===void 0&&(h=y(ae,he));let X=_?y(ae,he):h;return X.width=ae,X.height=he,X.getContext("2d").drawImage(b,0,0,ae,he),Ne("WebGLRenderer: Texture has been resized from ("+ee.width+"x"+ee.height+") to ("+ae+"x"+he+")."),X}else return"data"in b&&Ne("WebGLRenderer: Image in DataTexture is too big ("+ee.width+"x"+ee.height+")."),b;return b}function p(b){return b.generateMipmaps}function M(b){n.generateMipmap(b)}function E(b){return b.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?n.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function S(b,_,z,J,ee,ae=!1){if(b!==null){if(n[b]!==void 0)return n[b];Ne("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let he;J&&(he=e.get("EXT_texture_norm16"),he||Ne("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let X=_;if(_===n.RED&&(z===n.FLOAT&&(X=n.R32F),z===n.HALF_FLOAT&&(X=n.R16F),z===n.UNSIGNED_BYTE&&(X=n.R8),z===n.UNSIGNED_SHORT&&he&&(X=he.R16_EXT),z===n.SHORT&&he&&(X=he.R16_SNORM_EXT)),_===n.RED_INTEGER&&(z===n.UNSIGNED_BYTE&&(X=n.R8UI),z===n.UNSIGNED_SHORT&&(X=n.R16UI),z===n.UNSIGNED_INT&&(X=n.R32UI),z===n.BYTE&&(X=n.R8I),z===n.SHORT&&(X=n.R16I),z===n.INT&&(X=n.R32I)),_===n.RG&&(z===n.FLOAT&&(X=n.RG32F),z===n.HALF_FLOAT&&(X=n.RG16F),z===n.UNSIGNED_BYTE&&(X=n.RG8),z===n.UNSIGNED_SHORT&&he&&(X=he.RG16_EXT),z===n.SHORT&&he&&(X=he.RG16_SNORM_EXT)),_===n.RG_INTEGER&&(z===n.UNSIGNED_BYTE&&(X=n.RG8UI),z===n.UNSIGNED_SHORT&&(X=n.RG16UI),z===n.UNSIGNED_INT&&(X=n.RG32UI),z===n.BYTE&&(X=n.RG8I),z===n.SHORT&&(X=n.RG16I),z===n.INT&&(X=n.RG32I)),_===n.RGB_INTEGER&&(z===n.UNSIGNED_BYTE&&(X=n.RGB8UI),z===n.UNSIGNED_SHORT&&(X=n.RGB16UI),z===n.UNSIGNED_INT&&(X=n.RGB32UI),z===n.BYTE&&(X=n.RGB8I),z===n.SHORT&&(X=n.RGB16I),z===n.INT&&(X=n.RGB32I)),_===n.RGBA_INTEGER&&(z===n.UNSIGNED_BYTE&&(X=n.RGBA8UI),z===n.UNSIGNED_SHORT&&(X=n.RGBA16UI),z===n.UNSIGNED_INT&&(X=n.RGBA32UI),z===n.BYTE&&(X=n.RGBA8I),z===n.SHORT&&(X=n.RGBA16I),z===n.INT&&(X=n.RGBA32I)),_===n.RGB&&(z===n.UNSIGNED_SHORT&&he&&(X=he.RGB16_EXT),z===n.SHORT&&he&&(X=he.RGB16_SNORM_EXT),z===n.UNSIGNED_INT_5_9_9_9_REV&&(X=n.RGB9_E5),z===n.UNSIGNED_INT_10F_11F_11F_REV&&(X=n.R11F_G11F_B10F)),_===n.RGBA){let $=ae?hr:et.getTransfer(ee);z===n.FLOAT&&(X=n.RGBA32F),z===n.HALF_FLOAT&&(X=n.RGBA16F),z===n.UNSIGNED_BYTE&&(X=$===ct?n.SRGB8_ALPHA8:n.RGBA8),z===n.UNSIGNED_SHORT&&he&&(X=he.RGBA16_EXT),z===n.SHORT&&he&&(X=he.RGBA16_SNORM_EXT),z===n.UNSIGNED_SHORT_4_4_4_4&&(X=n.RGBA4),z===n.UNSIGNED_SHORT_5_5_5_1&&(X=n.RGB5_A1)}return(X===n.R16F||X===n.R32F||X===n.RG16F||X===n.RG32F||X===n.RGBA16F||X===n.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function I(b,_){let z;return b?_===null||_===An||_===Gs?z=n.DEPTH24_STENCIL8:_===Rn?z=n.DEPTH32F_STENCIL8:_===Vs&&(z=n.DEPTH24_STENCIL8,Ne("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===An||_===Gs?z=n.DEPTH_COMPONENT24:_===Rn?z=n.DEPTH_COMPONENT32F:_===Vs&&(z=n.DEPTH_COMPONENT16),z}function T(b,_){return p(b)===!0||b.isFramebufferTexture&&b.minFilter!==Ct&&b.minFilter!==Bt?Math.log2(Math.max(_.width,_.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?_.mipmaps.length:1}function L(b){let _=b.target;_.removeEventListener("dispose",L),A(_),_.isVideoTexture&&u.delete(_),_.isHTMLTexture&&d.delete(_)}function x(b){let _=b.target;_.removeEventListener("dispose",x),R(_)}function A(b){let _=i.get(b);if(_.__webglInit===void 0)return;let z=b.source,J=f.get(z);if(J){let ee=J[_.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&U(b),Object.keys(J).length===0&&f.delete(z)}i.remove(b)}function U(b){let _=i.get(b);n.deleteTexture(_.__webglTexture);let z=b.source,J=f.get(z);delete J[_.__cacheKey],a.memory.textures--}function R(b){let _=i.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),i.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(_.__webglFramebuffer[J]))for(let ee=0;ee<_.__webglFramebuffer[J].length;ee++)n.deleteFramebuffer(_.__webglFramebuffer[J][ee]);else n.deleteFramebuffer(_.__webglFramebuffer[J]);_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer[J])}else{if(Array.isArray(_.__webglFramebuffer))for(let J=0;J<_.__webglFramebuffer.length;J++)n.deleteFramebuffer(_.__webglFramebuffer[J]);else n.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&n.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let J=0;J<_.__webglColorRenderbuffer.length;J++)_.__webglColorRenderbuffer[J]&&n.deleteRenderbuffer(_.__webglColorRenderbuffer[J]);_.__webglDepthRenderbuffer&&n.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let z=b.textures;for(let J=0,ee=z.length;J<ee;J++){let ae=i.get(z[J]);ae.__webglTexture&&(n.deleteTexture(ae.__webglTexture),a.memory.textures--),i.remove(z[J])}i.remove(b)}let B=0;function G(){B=0}function W(){return B}function w(b){B=b}function P(){let b=B;return b>=s.maxTextures&&Ne("WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+s.maxTextures),B+=1,b}function F(b){let _=[];return _.push(b.wrapS),_.push(b.wrapT),_.push(b.wrapR||0),_.push(b.magFilter),_.push(b.minFilter),_.push(b.anisotropy),_.push(b.internalFormat),_.push(b.format),_.push(b.type),_.push(b.generateMipmaps),_.push(b.premultiplyAlpha),_.push(b.flipY),_.push(b.unpackAlignment),_.push(b.colorSpace),_.join()}function Y(b,_){let z=i.get(b);if(b.isVideoTexture&&Ve(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&z.__version!==b.version){let J=b.image;if(J===null)Ne("WebGLRenderer: Texture marked for update but no image data found.");else if(J.complete===!1)Ne("WebGLRenderer: Texture marked for update but image is incomplete");else{Ae(z,b,_);return}}else b.isExternalTexture&&(z.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,z.__webglTexture,n.TEXTURE0+_)}function K(b,_){let z=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&z.__version!==b.version){Ae(z,b,_);return}else b.isExternalTexture&&(z.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,z.__webglTexture,n.TEXTURE0+_)}function ne(b,_){let z=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&z.__version!==b.version){Ae(z,b,_);return}t.bindTexture(n.TEXTURE_3D,z.__webglTexture,n.TEXTURE0+_)}function pe(b,_){let z=i.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&z.__version!==b.version){Fe(z,b,_);return}t.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture,n.TEXTURE0+_)}let ge={[Ts]:n.REPEAT,[vn]:n.CLAMP_TO_EDGE,[za]:n.MIRRORED_REPEAT},Be={[Ct]:n.NEAREST,[dd]:n.NEAREST_MIPMAP_NEAREST,[Br]:n.NEAREST_MIPMAP_LINEAR,[Bt]:n.LINEAR,[yo]:n.LINEAR_MIPMAP_NEAREST,[wi]:n.LINEAR_MIPMAP_LINEAR},je={[md]:n.NEVER,[yd]:n.ALWAYS,[gd]:n.LESS,[sl]:n.LEQUAL,[_d]:n.EQUAL,[rl]:n.GEQUAL,[xd]:n.GREATER,[vd]:n.NOTEQUAL};function ze(b,_){if(_.type===Rn&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Bt||_.magFilter===yo||_.magFilter===Br||_.magFilter===wi||_.minFilter===Bt||_.minFilter===yo||_.minFilter===Br||_.minFilter===wi)&&Ne("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(b,n.TEXTURE_WRAP_S,ge[_.wrapS]),n.texParameteri(b,n.TEXTURE_WRAP_T,ge[_.wrapT]),(b===n.TEXTURE_3D||b===n.TEXTURE_2D_ARRAY)&&n.texParameteri(b,n.TEXTURE_WRAP_R,ge[_.wrapR]),n.texParameteri(b,n.TEXTURE_MAG_FILTER,Be[_.magFilter]),n.texParameteri(b,n.TEXTURE_MIN_FILTER,Be[_.minFilter]),_.compareFunction&&(n.texParameteri(b,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(b,n.TEXTURE_COMPARE_FUNC,je[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ct||_.minFilter!==Br&&_.minFilter!==wi||_.type===Rn&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||i.get(_).__currentAnisotropy){let z=e.get("EXT_texture_filter_anisotropic");n.texParameterf(b,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy}}}function q(b,_){let z=!1;b.__webglInit===void 0&&(b.__webglInit=!0,_.addEventListener("dispose",L));let J=_.source,ee=f.get(J);ee===void 0&&(ee={},f.set(J,ee));let ae=F(_);if(ae!==b.__cacheKey){ee[ae]===void 0&&(ee[ae]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,z=!0),ee[ae].usedTimes++;let he=ee[b.__cacheKey];he!==void 0&&(ee[b.__cacheKey].usedTimes--,he.usedTimes===0&&U(_)),b.__cacheKey=ae,b.__webglTexture=ee[ae].texture}return z}function oe(b,_,z){return Math.floor(Math.floor(b/z)/_)}function ie(b,_,z,J){let ae=b.updateRanges;if(ae.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,_.width,_.height,z,J,_.data);else{ae.sort((Te,de)=>Te.start-de.start);let he=0;for(let Te=1;Te<ae.length;Te++){let de=ae[he],le=ae[Te],We=de.start+de.count,Je=oe(le.start,_.width,4),rt=oe(de.start,_.width,4);le.start<=We+1&&Je===rt&&oe(le.start+le.count-1,_.width,4)===Je?de.count=Math.max(de.count,le.start+le.count-de.start):(++he,ae[he]=le)}ae.length=he+1;let X=t.getParameter(n.UNPACK_ROW_LENGTH),$=t.getParameter(n.UNPACK_SKIP_PIXELS),Se=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,_.width);for(let Te=0,de=ae.length;Te<de;Te++){let le=ae[Te],We=Math.floor(le.start/4),Je=Math.ceil(le.count/4),rt=We%_.width,N=Math.floor(We/_.width),ce=Je,Z=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,rt),t.pixelStorei(n.UNPACK_SKIP_ROWS,N),t.texSubImage2D(n.TEXTURE_2D,0,rt,N,ce,Z,z,J,_.data)}b.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,X),t.pixelStorei(n.UNPACK_SKIP_PIXELS,$),t.pixelStorei(n.UNPACK_SKIP_ROWS,Se)}}function Ae(b,_,z){let J=n.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(J=n.TEXTURE_2D_ARRAY),_.isData3DTexture&&(J=n.TEXTURE_3D);let ee=q(b,_),ae=_.source;t.bindTexture(J,b.__webglTexture,n.TEXTURE0+z);let he=i.get(ae);if(ae.version!==he.__version||ee===!0){if(t.activeTexture(n.TEXTURE0+z),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){let Z=et.getPrimaries(et.workingColorSpace),be=_.colorSpace===ii?null:et.getPrimaries(_.colorSpace),fe=_.colorSpace===ii||Z===be?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe)}t.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment);let $=m(_.image,!1,s.maxTextureSize);$=re(_,$);let Se=r.convert(_.format,_.colorSpace),Te=r.convert(_.type),de=S(_.internalFormat,Se,Te,_.normalized,_.colorSpace,_.isVideoTexture);ze(J,_);let le,We=_.mipmaps,Je=_.isVideoTexture!==!0,rt=he.__version===void 0||ee===!0,N=ae.dataReady,ce=T(_,$);if(_.isDepthTexture)de=I(_.format===Ai,_.type),rt&&(Je?t.texStorage2D(n.TEXTURE_2D,1,de,$.width,$.height):t.texImage2D(n.TEXTURE_2D,0,de,$.width,$.height,0,Se,Te,null));else if(_.isDataTexture)if(We.length>0){Je&&rt&&t.texStorage2D(n.TEXTURE_2D,ce,de,We[0].width,We[0].height);for(let Z=0,be=We.length;Z<be;Z++)le=We[Z],Je?N&&t.texSubImage2D(n.TEXTURE_2D,Z,0,0,le.width,le.height,Se,Te,le.data):t.texImage2D(n.TEXTURE_2D,Z,de,le.width,le.height,0,Se,Te,le.data);_.generateMipmaps=!1}else Je?(rt&&t.texStorage2D(n.TEXTURE_2D,ce,de,$.width,$.height),N&&ie(_,$,Se,Te)):t.texImage2D(n.TEXTURE_2D,0,de,$.width,$.height,0,Se,Te,$.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Je&&rt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ce,de,We[0].width,We[0].height,$.depth);for(let Z=0,be=We.length;Z<be;Z++)if(le=We[Z],_.format!==Mn)if(Se!==null)if(Je){if(N)if(_.layerUpdates.size>0){let fe=Jc(le.width,le.height,_.format,_.type);for(let te of _.layerUpdates){let Ie=le.data.subarray(te*fe/le.data.BYTES_PER_ELEMENT,(te+1)*fe/le.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Z,0,0,te,le.width,le.height,1,Se,Ie)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Z,0,0,0,le.width,le.height,$.depth,Se,le.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,Z,de,le.width,le.height,$.depth,0,le.data,0,0);else Ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Je?N&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,Z,0,0,0,le.width,le.height,$.depth,Se,Te,le.data):t.texImage3D(n.TEXTURE_2D_ARRAY,Z,de,le.width,le.height,$.depth,0,Se,Te,le.data)}else{Je&&rt&&t.texStorage2D(n.TEXTURE_2D,ce,de,We[0].width,We[0].height);for(let Z=0,be=We.length;Z<be;Z++)le=We[Z],_.format!==Mn?Se!==null?Je?N&&t.compressedTexSubImage2D(n.TEXTURE_2D,Z,0,0,le.width,le.height,Se,le.data):t.compressedTexImage2D(n.TEXTURE_2D,Z,de,le.width,le.height,0,le.data):Ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Je?N&&t.texSubImage2D(n.TEXTURE_2D,Z,0,0,le.width,le.height,Se,Te,le.data):t.texImage2D(n.TEXTURE_2D,Z,de,le.width,le.height,0,Se,Te,le.data)}else if(_.isDataArrayTexture)if(Je){if(rt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ce,de,$.width,$.height,$.depth),N)if(_.layerUpdates.size>0){let Z=Jc($.width,$.height,_.format,_.type);for(let be of _.layerUpdates){let fe=$.data.subarray(be*Z/$.data.BYTES_PER_ELEMENT,(be+1)*Z/$.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,be,$.width,$.height,1,Se,Te,fe)}_.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,Se,Te,$.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,de,$.width,$.height,$.depth,0,Se,Te,$.data);else if(_.isData3DTexture)Je?(rt&&t.texStorage3D(n.TEXTURE_3D,ce,de,$.width,$.height,$.depth),N&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,Se,Te,$.data)):t.texImage3D(n.TEXTURE_3D,0,de,$.width,$.height,$.depth,0,Se,Te,$.data);else if(_.isFramebufferTexture){if(rt)if(Je)t.texStorage2D(n.TEXTURE_2D,ce,de,$.width,$.height);else{let Z=$.width,be=$.height;for(let fe=0;fe<ce;fe++)t.texImage2D(n.TEXTURE_2D,fe,de,Z,be,0,Se,Te,null),Z>>=1,be>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in n){let Z=n.canvas;if(Z.hasAttribute("layoutsubtree")||Z.setAttribute("layoutsubtree","true"),$.parentNode!==Z){Z.appendChild($),d.add(_),Z.onpaint=Ye=>{let wt=Ye.changedElements;for(let ut of d)wt.includes(ut.image)&&(ut.needsUpdate=!0)},Z.requestPaint();return}let be=0,fe=n.RGBA,te=n.RGBA,Ie=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,be,fe,te,Ie,$),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(We.length>0){if(Je&&rt){let Z=lt(We[0]);t.texStorage2D(n.TEXTURE_2D,ce,de,Z.width,Z.height)}for(let Z=0,be=We.length;Z<be;Z++)le=We[Z],Je?N&&t.texSubImage2D(n.TEXTURE_2D,Z,0,0,Se,Te,le):t.texImage2D(n.TEXTURE_2D,Z,de,Se,Te,le);_.generateMipmaps=!1}else if(Je){if(rt){let Z=lt($);t.texStorage2D(n.TEXTURE_2D,ce,de,Z.width,Z.height)}N&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Se,Te,$)}else t.texImage2D(n.TEXTURE_2D,0,de,Se,Te,$);p(_)&&M(J),he.__version=ae.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function Fe(b,_,z){if(_.image.length!==6)return;let J=q(b,_),ee=_.source;t.bindTexture(n.TEXTURE_CUBE_MAP,b.__webglTexture,n.TEXTURE0+z);let ae=i.get(ee);if(ee.version!==ae.__version||J===!0){t.activeTexture(n.TEXTURE0+z);let he=et.getPrimaries(et.workingColorSpace),X=_.colorSpace===ii?null:et.getPrimaries(_.colorSpace),$=_.colorSpace===ii||he===X?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,$);let Se=_.isCompressedTexture||_.image[0].isCompressedTexture,Te=_.image[0]&&_.image[0].isDataTexture,de=[];for(let te=0;te<6;te++)!Se&&!Te?de[te]=m(_.image[te],!0,s.maxCubemapSize):de[te]=Te?_.image[te].image:_.image[te],de[te]=re(_,de[te]);let le=de[0],We=r.convert(_.format,_.colorSpace),Je=r.convert(_.type),rt=S(_.internalFormat,We,Je,_.normalized,_.colorSpace),N=_.isVideoTexture!==!0,ce=ae.__version===void 0||J===!0,Z=ee.dataReady,be=T(_,le);ze(n.TEXTURE_CUBE_MAP,_);let fe;if(Se){N&&ce&&t.texStorage2D(n.TEXTURE_CUBE_MAP,be,rt,le.width,le.height);for(let te=0;te<6;te++){fe=de[te].mipmaps;for(let Ie=0;Ie<fe.length;Ie++){let Ye=fe[Ie];_.format!==Mn?We!==null?N?Z&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ie,0,0,Ye.width,Ye.height,We,Ye.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ie,rt,Ye.width,Ye.height,0,Ye.data):Ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?Z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ie,0,0,Ye.width,Ye.height,We,Je,Ye.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ie,rt,Ye.width,Ye.height,0,We,Je,Ye.data)}}}else{if(fe=_.mipmaps,N&&ce){fe.length>0&&be++;let te=lt(de[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,be,rt,te.width,te.height)}for(let te=0;te<6;te++)if(Te){N?Z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,de[te].width,de[te].height,We,Je,de[te].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,rt,de[te].width,de[te].height,0,We,Je,de[te].data);for(let Ie=0;Ie<fe.length;Ie++){let wt=fe[Ie].image[te].image;N?Z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ie+1,0,0,wt.width,wt.height,We,Je,wt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ie+1,rt,wt.width,wt.height,0,We,Je,wt.data)}}else{N?Z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,We,Je,de[te]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,rt,We,Je,de[te]);for(let Ie=0;Ie<fe.length;Ie++){let Ye=fe[Ie];N?Z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ie+1,0,0,We,Je,Ye.image[te]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ie+1,rt,We,Je,Ye.image[te])}}}p(_)&&M(n.TEXTURE_CUBE_MAP),ae.__version=ee.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function De(b,_,z,J,ee,ae){let he=r.convert(z.format,z.colorSpace),X=r.convert(z.type),$=S(z.internalFormat,he,X,z.normalized,z.colorSpace),Se=i.get(_),Te=i.get(z);if(Te.__renderTarget=_,!Se.__hasExternalTextures){let de=Math.max(1,_.width>>ae),le=Math.max(1,_.height>>ae);ee===n.TEXTURE_3D||ee===n.TEXTURE_2D_ARRAY?t.texImage3D(ee,ae,$,de,le,_.depth,0,he,X,null):t.texImage2D(ee,ae,$,de,le,0,he,X,null)}t.bindFramebuffer(n.FRAMEBUFFER,b),Re(_)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,J,ee,Te.__webglTexture,0,Ge(_)):(ee===n.TEXTURE_2D||ee>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,J,ee,Te.__webglTexture,ae),t.bindFramebuffer(n.FRAMEBUFFER,null)}function nt(b,_,z){if(n.bindRenderbuffer(n.RENDERBUFFER,b),_.depthBuffer){let J=_.depthTexture,ee=J&&J.isDepthTexture?J.type:null,ae=I(_.stencilBuffer,ee),he=_.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Re(_)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ge(_),ae,_.width,_.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ge(_),ae,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,ae,_.width,_.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,he,n.RENDERBUFFER,b)}else{let J=_.textures;for(let ee=0;ee<J.length;ee++){let ae=J[ee],he=r.convert(ae.format,ae.colorSpace),X=r.convert(ae.type),$=S(ae.internalFormat,he,X,ae.normalized,ae.colorSpace);Re(_)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ge(_),$,_.width,_.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ge(_),$,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,$,_.width,_.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ke(b,_,z){let J=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,b),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let ee=i.get(_.depthTexture);if(ee.__renderTarget=_,(!ee.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),J){if(ee.__webglInit===void 0&&(ee.__webglInit=!0,_.depthTexture.addEventListener("dispose",L)),ee.__webglTexture===void 0){ee.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,ee.__webglTexture),ze(n.TEXTURE_CUBE_MAP,_.depthTexture);let Se=r.convert(_.depthTexture.format),Te=r.convert(_.depthTexture.type),de;_.depthTexture.format===zn?de=n.DEPTH_COMPONENT24:_.depthTexture.format===Ai&&(de=n.DEPTH24_STENCIL8);for(let le=0;le<6;le++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,de,_.width,_.height,0,Se,Te,null)}}else Y(_.depthTexture,0);let ae=ee.__webglTexture,he=Ge(_),X=J?n.TEXTURE_CUBE_MAP_POSITIVE_X+z:n.TEXTURE_2D,$=_.depthTexture.format===Ai?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(_.depthTexture.format===zn)Re(_)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,$,X,ae,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,$,X,ae,0);else if(_.depthTexture.format===Ai)Re(_)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,$,X,ae,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,$,X,ae,0);else throw new Error("Unknown depthTexture format")}function j(b){let _=i.get(b),z=b.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==b.depthTexture){let J=b.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),J){let ee=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,J.removeEventListener("dispose",ee)};J.addEventListener("dispose",ee),_.__depthDisposeCallback=ee}_.__boundDepthTexture=J}if(b.depthTexture&&!_.__autoAllocateDepthBuffer)if(z)for(let J=0;J<6;J++)ke(_.__webglFramebuffer[J],b,J);else{let J=b.texture.mipmaps;J&&J.length>0?ke(_.__webglFramebuffer[0],b,0):ke(_.__webglFramebuffer,b,0)}else if(z){_.__webglDepthbuffer=[];for(let J=0;J<6;J++)if(t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[J]),_.__webglDepthbuffer[J]===void 0)_.__webglDepthbuffer[J]=n.createRenderbuffer(),nt(_.__webglDepthbuffer[J],b,!1);else{let ee=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=_.__webglDepthbuffer[J];n.bindRenderbuffer(n.RENDERBUFFER,ae),n.framebufferRenderbuffer(n.FRAMEBUFFER,ee,n.RENDERBUFFER,ae)}}else{let J=b.texture.mipmaps;if(J&&J.length>0?t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=n.createRenderbuffer(),nt(_.__webglDepthbuffer,b,!1);else{let ee=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=_.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ae),n.framebufferRenderbuffer(n.FRAMEBUFFER,ee,n.RENDERBUFFER,ae)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function se(b,_,z){let J=i.get(b);_!==void 0&&De(J.__webglFramebuffer,b,b.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),z!==void 0&&j(b)}function Q(b){let _=b.texture,z=i.get(b),J=i.get(_);b.addEventListener("dispose",x);let ee=b.textures,ae=b.isWebGLCubeRenderTarget===!0,he=ee.length>1;if(he||(J.__webglTexture===void 0&&(J.__webglTexture=n.createTexture()),J.__version=_.version,a.memory.textures++),ae){z.__webglFramebuffer=[];for(let X=0;X<6;X++)if(_.mipmaps&&_.mipmaps.length>0){z.__webglFramebuffer[X]=[];for(let $=0;$<_.mipmaps.length;$++)z.__webglFramebuffer[X][$]=n.createFramebuffer()}else z.__webglFramebuffer[X]=n.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){z.__webglFramebuffer=[];for(let X=0;X<_.mipmaps.length;X++)z.__webglFramebuffer[X]=n.createFramebuffer()}else z.__webglFramebuffer=n.createFramebuffer();if(he)for(let X=0,$=ee.length;X<$;X++){let Se=i.get(ee[X]);Se.__webglTexture===void 0&&(Se.__webglTexture=n.createTexture(),a.memory.textures++)}if(b.samples>0&&Re(b)===!1){z.__webglMultisampledFramebuffer=n.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let X=0;X<ee.length;X++){let $=ee[X];z.__webglColorRenderbuffer[X]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,z.__webglColorRenderbuffer[X]);let Se=r.convert($.format,$.colorSpace),Te=r.convert($.type),de=S($.internalFormat,Se,Te,$.normalized,$.colorSpace,b.isXRRenderTarget===!0),le=Ge(b);n.renderbufferStorageMultisample(n.RENDERBUFFER,le,de,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+X,n.RENDERBUFFER,z.__webglColorRenderbuffer[X])}n.bindRenderbuffer(n.RENDERBUFFER,null),b.depthBuffer&&(z.__webglDepthRenderbuffer=n.createRenderbuffer(),nt(z.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ae){t.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),ze(n.TEXTURE_CUBE_MAP,_);for(let X=0;X<6;X++)if(_.mipmaps&&_.mipmaps.length>0)for(let $=0;$<_.mipmaps.length;$++)De(z.__webglFramebuffer[X][$],b,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+X,$);else De(z.__webglFramebuffer[X],b,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+X,0);p(_)&&M(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(he){for(let X=0,$=ee.length;X<$;X++){let Se=ee[X],Te=i.get(Se),de=n.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(de=b.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(de,Te.__webglTexture),ze(de,Se),De(z.__webglFramebuffer,b,Se,n.COLOR_ATTACHMENT0+X,de,0),p(Se)&&M(de)}t.unbindTexture()}else{let X=n.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(X=b.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(X,J.__webglTexture),ze(X,_),_.mipmaps&&_.mipmaps.length>0)for(let $=0;$<_.mipmaps.length;$++)De(z.__webglFramebuffer[$],b,_,n.COLOR_ATTACHMENT0,X,$);else De(z.__webglFramebuffer,b,_,n.COLOR_ATTACHMENT0,X,0);p(_)&&M(X),t.unbindTexture()}b.depthBuffer&&j(b)}function ye(b){let _=b.textures;for(let z=0,J=_.length;z<J;z++){let ee=_[z];if(p(ee)){let ae=E(b),he=i.get(ee).__webglTexture;t.bindTexture(ae,he),M(ae),t.unbindTexture()}}}let me=[],He=[];function C(b){if(b.samples>0){if(Re(b)===!1){let _=b.textures,z=b.width,J=b.height,ee=n.COLOR_BUFFER_BIT,ae=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,he=i.get(b),X=_.length>1;if(X)for(let Se=0;Se<_.length;Se++)t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer);let $=b.texture.mipmaps;$&&$.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let Se=0;Se<_.length;Se++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(ee|=n.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(ee|=n.STENCIL_BUFFER_BIT)),X){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,he.__webglColorRenderbuffer[Se]);let Te=i.get(_[Se]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Te,0)}n.blitFramebuffer(0,0,z,J,0,0,z,J,ee,n.NEAREST),l===!0&&(me.length=0,He.length=0,me.push(n.COLOR_ATTACHMENT0+Se),b.depthBuffer&&b.resolveDepthBuffer===!1&&(me.push(ae),He.push(ae),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,He)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,me))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),X)for(let Se=0;Se<_.length;Se++){t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.RENDERBUFFER,he.__webglColorRenderbuffer[Se]);let Te=i.get(_[Se]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.TEXTURE_2D,Te,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){let _=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[_])}}}function Ge(b){return Math.min(s.maxSamples,b.samples)}function Re(b){let _=i.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Ve(b){let _=a.render.frame;u.get(b)!==_&&(u.set(b,_),b.update())}function re(b,_){let z=b.colorSpace,J=b.format,ee=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||z!==cr&&z!==ii&&(et.getTransfer(z)===ct?(J!==Mn||ee!==en)&&Ne("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Oe("WebGLTextures: Unsupported texture color space:",z)),_}function lt(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=P,this.resetTextureUnits=G,this.getTextureUnits=W,this.setTextureUnits=w,this.setTexture2D=Y,this.setTexture2DArray=K,this.setTexture3D=ne,this.setTextureCube=pe,this.rebindTextures=se,this.setupRenderTarget=Q,this.updateRenderTargetMipmap=ye,this.updateMultisampleRenderTarget=C,this.setupDepthRenderbuffer=j,this.setupFrameBufferTexture=De,this.useMultisampledRTT=Re,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function av(n,e){function t(i,s=ii){let r,a=et.getTransfer(s);if(i===en)return n.UNSIGNED_BYTE;if(i===So)return n.UNSIGNED_SHORT_4_4_4_4;if(i===bo)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Oc)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Bc)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Uc)return n.BYTE;if(i===Fc)return n.SHORT;if(i===Vs)return n.UNSIGNED_SHORT;if(i===Mo)return n.INT;if(i===An)return n.UNSIGNED_INT;if(i===Rn)return n.FLOAT;if(i===Gn)return n.HALF_FLOAT;if(i===zc)return n.ALPHA;if(i===kc)return n.RGB;if(i===Mn)return n.RGBA;if(i===zn)return n.DEPTH_COMPONENT;if(i===Ai)return n.DEPTH_STENCIL;if(i===Hc)return n.RED;if(i===Eo)return n.RED_INTEGER;if(i===Ri)return n.RG;if(i===To)return n.RG_INTEGER;if(i===wo)return n.RGBA_INTEGER;if(i===zr||i===kr||i===Hr||i===Vr)if(a===ct)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===zr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===kr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Hr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Vr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===zr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===kr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Hr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Vr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Ao||i===Ro||i===Co||i===Io)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Ao)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ro)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Co)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Io)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Po||i===Lo||i===Do||i===No||i===Uo||i===Gr||i===Fo)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Po||i===Lo)return a===ct?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Do)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===No)return r.COMPRESSED_R11_EAC;if(i===Uo)return r.COMPRESSED_SIGNED_R11_EAC;if(i===Gr)return r.COMPRESSED_RG11_EAC;if(i===Fo)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Oo||i===Bo||i===zo||i===ko||i===Ho||i===Vo||i===Go||i===Wo||i===Xo||i===qo||i===Yo||i===Zo||i===Jo||i===$o)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Oo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Bo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===zo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ko)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Ho)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Vo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Go)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Wo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Xo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===qo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Yo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Zo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Jo)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===$o)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ko||i===jo||i===Qo)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Ko)return a===ct?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===jo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Qo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===el||i===tl||i===Wr||i===nl)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===el)return r.COMPRESSED_RED_RGTC1_EXT;if(i===tl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Wr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===nl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Gs?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}var ov=`
void main() {
...
}`,ph=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let i=new xr(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,i=new dn({vertexShader:ov,fragmentShader:lv,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new _e(new Kt(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},mh=class extends kn{constructor(e,t){super();let i=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,u=null,d=null,h=null,f=null,g=null,y=typeof XRWebGLBinding<"u",m=new ph,p={},M=t.getContextAttributes(),E=null,S=null,I=[],T=[],L=new ue,x=null,A=new Dt;A.viewport=new yt;let U=new Dt;U.viewport=new yt;let R=[A,U],B=new po,G=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let oe=I[q];return oe===void 0&&(oe=new Ps,I[q]=oe),oe.getTargetRaySpace()},this.getControllerGrip=function(q){let oe=I[q];return oe===void 0&&(oe=new Ps,I[q]=oe),oe.getGripSpace()},this.getHand=function(q){let oe=I[q];return oe===void 0&&(oe=new Ps,I[q]=oe),oe.getHandSpace()};function w(q){let oe=T.indexOf(q.inputSource);if(oe===-1)return;let ie=I[oe];ie!==void 0&&(ie.update(q.inputSource,q.frame,c||a),ie.dispatchEvent({type:q.type,data:q.inputSource}))}function P(){s.removeEventListener("select",w),s.removeEventListener("selectstart",w),s.removeEventListener("selectend",w),s.removeEventListener("squeeze",w),s.removeEventListener("squeezestart",w),s.removeEventListener("squeezeend",w),s.removeEventListener("end",P),s.removeEventListener("inputsourceschange",F);for(let q=0;q<I.length;q++){let oe=T[q];oe!==null&&(T[q]=null,I[q].disconnect(oe))}G=null,W=null,m.reset();for(let q in p)delete p[q];e.setRenderTarget(E),f=null,h=null,d=null,s=null,S=null,ze.stop(),i.isPresenting=!1,e.setPixelRatio(x),e.setSize(L.width,L.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){r=q,i.isPresenting===!0&&Ne("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,i.isPresenting===!0&&Ne("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(q){c=q},this.getBaseLayer=function(){return h!==null?h:f},this.getBinding=function(){return d===null&&y&&(d=new XRWebGLBinding(s,t)),d},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(q){if(s=q,s!==null){if(E=e.getRenderTarget(),s.addEventListener("select",w),s.addEventListener("selectstart",w),s.addEventListener("selectend",w),s.addEventListener("squeeze",w),s.addEventListener("squeezestart",w),s.addEventListener("squeezeend",w),s.addEventListener("end",P),s.addEventListener("inputsourceschange",F),M.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(L),y&&"createProjectionLayer"in XRWebGLBinding.prototype){let ie=null,Ae=null,Fe=null;M.depth&&(Fe=M.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ie=M.stencil?Ai:zn,Ae=M.stencil?Gs:An);let De={colorFormat:t.RGBA8,depthFormat:Fe,scaleFactor:r};d=this.getBinding(),h=d.createProjectionLayer(De),s.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),S=new hn(h.textureWidth,h.textureHeight,{format:Mn,type:en,depthTexture:new ni(h.textureWidth,h.textureHeight,Ae,void 0,void 0,void 0,void 0,void 0,void 0,ie),stencilBuffer:M.stencil,colorSpace:e.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{let ie={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,t,ie),s.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),S=new hn(f.framebufferWidth,f.framebufferHeight,{format:Mn,type:en,colorSpace:e.outputColorSpace,stencilBuffer:M.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),ze.setContext(s),ze.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function F(q){for(let oe=0;oe<q.removed.length;oe++){let ie=q.removed[oe],Ae=T.indexOf(ie);Ae>=0&&(T[Ae]=null,I[Ae].disconnect(ie))}for(let oe=0;oe<q.added.length;oe++){let ie=q.added[oe],Ae=T.indexOf(ie);if(Ae===-1){for(let De=0;De<I.length;De++)if(De>=T.length){T.push(ie),Ae=De;break}else if(T[De]===null){T[De]=ie,Ae=De;break}if(Ae===-1)break}let Fe=I[Ae];Fe&&Fe.connect(ie)}}let Y=new D,K=new D;function ne(q,oe,ie){Y.setFromMatrixPosition(oe.matrixWorld),K.setFromMatrixPosition(ie.matrixWorld);let Ae=Y.distanceTo(K),Fe=oe.projectionMatrix.elements,De=ie.projectionMatrix.elements,nt=Fe[14]/(Fe[10]-1),ke=Fe[14]/(Fe[10]+1),j=(Fe[9]+1)/Fe[5],se=(Fe[9]-1)/Fe[5],Q=(Fe[8]-1)/Fe[0],ye=(De[8]+1)/De[0],me=nt*Q,He=nt*ye,C=Ae/(-Q+ye),Ge=C*-Q;if(oe.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(Ge),q.translateZ(C),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),Fe[10]===-1)q.projectionMatrix.copy(oe.projectionMatrix),q.projectionMatrixInverse.copy(oe.projectionMatrixInverse);else{let Re=nt+C,Ve=ke+C,re=me-Ge,lt=He+(Ae-Ge),b=j*ke/Ve*Re,_=se*ke/Ve*Re;q.projectionMatrix.makePerspective(re,lt,b,_,Re,Ve),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function pe(q,oe){oe===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(oe.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(s===null)return;let oe=q.near,ie=q.far;m.texture!==null&&(m.depthNear>0&&(oe=m.depthNear),m.depthFar>0&&(ie=m.depthFar)),B.near=U.near=A.near=oe,B.far=U.far=A.far=ie,(G!==B.near||W!==B.far)&&(s.updateRenderState({depthNear:B.near,depthFar:B.far}),G=B.near,W=B.far),B.layers.mask=q.layers.mask|6,A.layers.mask=B.layers.mask&-5,U.layers.mask=B.layers.mask&-3;let Ae=q.parent,Fe=B.cameras;pe(B,Ae);for(let De=0;De<Fe.length;De++)pe(Fe[De],Ae);Fe.length===2?ne(B,A,U):B.projectionMatrix.copy(A.projectionMatrix),ge(q,B,Ae)};function ge(q,oe,ie){ie===null?q.matrix.copy(oe.matrixWorld):(q.matrix.copy(ie.matrixWorld),q.matrix.invert(),q.matrix.multiply(oe.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(oe.projectionMatrix),q.projectionMatrixInverse.copy(oe.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=Rs*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return B},this.getFoveation=function(){if(!(h===null&&f===null))return l},this.setFoveation=function(q){l=q,h!==null&&(h.fixedFoveation=q),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=q)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(B)},this.getCameraTexture=function(q){return p[q]};let Be=null;function je(q,oe){if(u=oe.getViewerPose(c||a),g=oe,u!==null){let ie=u.views;f!==null&&(e.setRenderTargetFramebuffer(S,f.framebuffer),e.setRenderTarget(S));let Ae=!1;ie.length!==B.cameras.length&&(B.cameras.length=0,Ae=!0);for(let ke=0;ke<ie.length;ke++){let j=ie[ke],se=null;if(f!==null)se=f.getViewport(j);else{let ye=d.getViewSubImage(h,j);se=ye.viewport,ke===0&&(e.setRenderTargetTextures(S,ye.colorTexture,ye.depthStencilTexture),e.setRenderTarget(S))}let Q=R[ke];Q===void 0&&(Q=new Dt,Q.layers.enable(ke),Q.viewport=new yt,R[ke]=Q),Q.matrix.fromArray(j.transform.matrix),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.projectionMatrix.fromArray(j.projectionMatrix),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert(),Q.viewport.set(se.x,se.y,se.width,se.height),ke===0&&(B.matrix.copy(Q.matrix),B.matrix.decompose(B.position,B.quaternion,B.scale)),Ae===!0&&B.cameras.push(Q)}let Fe=s.enabledFeatures;if(Fe&&Fe.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&y){d=i.getBinding();let ke=d.getDepthInformation(ie[0]);ke&&ke.isValid&&ke.texture&&m.init(ke,s.renderState)}if(Fe&&Fe.includes("camera-access")&&y){e.state.unbindTexture(),d=i.getBinding();for(let ke=0;ke<ie.length;ke++){let j=ie[ke].camera;if(j){let se=p[j];se||(se=new xr,p[j]=se);let Q=d.getCameraImage(j);se.sourceTexture=Q}}}}for(let ie=0;ie<I.length;ie++){let Ae=T[ie],Fe=I[ie];Ae!==null&&Fe!==void 0&&Fe.update(Ae,oe,c||a)}Be&&Be(q,oe),oe.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:oe}),g=null}let ze=new ef;ze.setAnimationLoop(je),this.setAnimationLoop=function(q){Be=q},this.dispose=function(){}}},cv=new xt,of=new Xe;of.set(-1,0,0,0,1,0,0,0,1);function hv(n,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,qc(n)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,M,E,S){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),d(m,p)):p.isMeshPhongMaterial?(r(m,p),u(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),h(m,p),p.isMeshPhysicalMaterial&&f(m,p,S)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),y(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,M,E):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Nt&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Nt&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let M=e.get(p),E=M.envMap,S=M.envMapRotation;E&&(m.envMap.value=E,m.envMapRotation.value.setFromMatrix4(cv.makeRotationFromEuler(S)).transpose(),E.isCubeTexture&&E.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(of),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,M,E){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*M,m.scale.value=E*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function d(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function h(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,M){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Nt&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=M.texture,m.transmissionSamplerSize.value.set(M.width,M.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function y(m,p){let M=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(M.matrixWorld),m.nearDistance.value=M.shadow.camera.near,m.farDistance.value=M.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function uv(n,e,t,i){let s={},r={},a=[],o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,E){let S=E.program;i.uniformBlockBinding(M,S)}function c(M,E){let S=s[M.id];S===void 0&&(g(M),S=u(M),s[M.id]=S,M.addEventListener("dispose",m));let I=E.program;i.updateUBOMapping(M,I);let T=e.render.frame;r[M.id]!==T&&(h(M),r[M.id]=T)}function u(M){let E=d();M.__bindingPointIndex=E;let S=n.createBuffer(),I=M.__size,T=M.usage;return n.bindBuffer(n.UNIFORM_BUFFER,S),n.bufferData(n.UNIFORM_BUFFER,I,T),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,E,S),S}function d(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return Oe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(M){let E=s[M.id],S=M.uniforms,I=M.__cache;n.bindBuffer(n.UNIFORM_BUFFER,E);for(let T=0,L=S.length;T<L;T++){let x=Array.isArray(S[T])?S[T]:[S[T]];for(let A=0,U=x.length;A<U;A++){let R=x[A];if(f(R,T,A,I)===!0){let B=R.__offset,G=Array.isArray(R.value)?R.value:[R.value],W=0;for(let w=0;w<G.length;w++){let P=G[w],F=y(P);typeof P=="number"||typeof P=="boolean"?(R.__data[0]=P,n.bufferSubData(n.UNIFORM_BUFFER,B+W,R.__data)):P.isMatrix3?(R.__data[0]=P.elements[0],R.__data[1]=P.elements[1],R.__data[2]=P.elements[2],R.__data[3]=0,R.__data[4]=P.elements[3],R.__data[5]=P.elements[4],R.__data[6]=P.elements[5],R.__data[7]=0,R.__data[8]=P.elements[6],R.__data[9]=P.elements[7],R.__data[10]=P.elements[8],R.__data[11]=0):ArrayBuffer.isView(P)?R.__data.set(new P.constructor(P.buffer,P.byteOffset,R.__data.length)):(P.toArray(R.__data,W),W+=F.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,B,R.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function f(M,E,S,I){let T=M.value,L=E+"_"+S;if(I[L]===void 0)return typeof T=="number"||typeof T=="boolean"?I[L]=T:ArrayBuffer.isView(T)?I[L]=T.slice():I[L]=T.clone(),!0;{let x=I[L];if(typeof T=="number"||typeof T=="boolean"){if(x!==T)return I[L]=T,!0}else{if(ArrayBuffer.isView(T))return!0;if(x.equals(T)===!1)return x.copy(T),!0}}return!1}function g(M){let E=M.uniforms,S=0,I=16;for(let L=0,x=E.length;L<x;L++){let A=Array.isArray(E[L])?E[L]:[E[L]];for(let U=0,R=A.length;U<R;U++){let B=A[U],G=Array.isArray(B.value)?B.value:[B.value];for(let W=0,w=G.length;W<w;W++){let P=G[W],F=y(P),Y=S%I,K=Y%F.boundary,ne=Y+K;S+=K,ne!==0&&I-ne<F.storage&&(S+=I-ne),B.__data=new Float32Array(F.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=S,S+=F.storage}}}let T=S%I;return T>0&&(S+=I-T),M.__size=S,M.__cache={},this}function y(M){let E={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(E.boundary=4,E.storage=4):M.isVector2?(E.boundary=8,E.storage=8):M.isVector3||M.isColor?(E.boundary=16,E.storage=12):M.isVector4?(E.boundary=16,E.storage=16):M.isMatrix3?(E.boundary=48,E.storage=48):M.isMatrix4?(E.boundary=64,E.storage=64):M.isTexture?Ne("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(E.boundary=16,E.storage=M.byteLength):Ne("WebGLRenderer: Unsupported uniform value type.",M),E}function m(M){let E=M.target;E.removeEventListener("dispose",m);let S=a.indexOf(E.__bindingPointIndex);a.splice(S,1),n.deleteBuffer(s[E.id]),delete s[E.id],delete r[E.id]}function p(){for(let M in s)n.deleteBuffer(s[M]);a=[],s={},r={}}return{bind:l,update:c,dispose:p}}var dv=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Wn=null;function fv(){return Wn===null&&(Wn=new Xa(dv,16,16,Ri,Gn),Wn.name="DFG_LUT",Wn.minFilter=Bt,Wn.magFilter=Bt,Wn.wrapS=vn,Wn.wrapT=vn,Wn.generateMipmaps=!1,Wn.needsUpdate=!0),Wn}var Ys=class{constructor(e={}){let{canvas:t=Md(),context:i=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:h=!1,outputBufferType:f=en}=e;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=a;let y=f,m=new Set([wo,To,Eo]),p=new Set([en,An,Vs,Gs,So,bo]),M=new Uint32Array(4),E=new Int32Array(4),S=new D,I=null,T=null,L=[],x=[],A=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=wn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let U=this,R=!1,B=null;this._outputColorSpace=Lt;let G=0,W=0,w=null,P=-1,F=null,Y=new yt,K=new yt,ne=null,pe=new qe(0),ge=0,Be=t.width,je=t.height,ze=1,q=null,oe=null,ie=new yt(0,0,Be,je),Ae=new yt(0,0,Be,je),Fe=!1,De=new Ns,nt=!1,ke=!1,j=new xt,se=new D,Q=new yt,ye={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},me=!1;function He(){return w===null?ze:1}let C=i;function Ge(v,O){return t.getContext(v,O)}try{let v={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${go}`),t.addEventListener("webglcontextlost",te,!1),t.addEventListener("webglcontextrestored",Ie,!1),t.addEventListener("webglcontextcreationerror",Ye,!1),C===null){let O="webgl2";if(C=Ge(O,v),C===null)throw Ge(O)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw Oe("WebGLRenderer: "+v.message),v}let Re,Ve,re,lt,b,_,z,J,ee,ae,he,X,$,Se,Te,de,le,We,Je,rt,N,ce,Z;function be(){Re=new y_(C),Re.init(),N=new av(C,Re),Ve=new d_(C,Re,e,N),re=new sv(C,Re),Ve.reversedDepthBuffer&&h&&re.buffers.depth.setReversed(!0),lt=new b_(C),b=new Wx,_=new rv(C,Re,re,b,Ve,N,lt),z=new v_(U),J=new Am(C),ce=new h_(C,J),ee=new M_(C,J,lt,ce),ae=new T_(C,ee,J,ce,lt),We=new E_(C,Ve,_),Te=new f_(b),he=new Gx(U,z,Re,Ve,ce,Te),X=new hv(U,b),$=new qx,Se=new jx(Re),le=new c_(U,z,re,ae,g,l),de=new iv(U,ae,Ve),Z=new uv(C,lt,Ve,re),Je=new u_(C,Re,lt),rt=new S_(C,Re,lt),lt.programs=he.programs,U.capabilities=Ve,U.extensions=Re,U.properties=b,U.renderLists=$,U.shadowMap=de,U.state=re,U.info=lt}be(),y!==en&&(A=new A_(y,t.width,t.height,s,r));let fe=new mh(U,C);this.xr=fe,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){let v=Re.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){let v=Re.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return ze},this.setPixelRatio=function(v){v!==void 0&&(ze=v,this.setSize(Be,je,!1))},this.getSize=function(v){return v.set(Be,je)},this.setSize=function(v,O,V=!0){if(fe.isPresenting){Ne("WebGLRenderer: Can't change size while VR device is presenting.");return}Be=v,je=O,t.width=Math.floor(v*ze),t.height=Math.floor(O*ze),V===!0&&(t.style.width=v+"px",t.style.height=O+"px"),A!==null&&A.setSize(t.width,t.height),this.setViewport(0,0,v,O)},this.getDrawingBufferSize=function(v){return v.set(Be*ze,je*ze).floor()},this.setDrawingBufferSize=function(v,O,V){Be=v,je=O,ze=V,t.width=Math.floor(v*V),t.height=Math.floor(O*V),this.setViewport(0,0,v,O)},this.setEffects=function(v){if(y===en){Oe("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let O=0;O<v.length;O++)if(v[O].isOutputPass===!0){Ne("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(Y)},this.getViewport=function(v){return v.copy(ie)},this.setViewport=function(v,O,V,k){v.isVector4?ie.set(v.x,v.y,v.z,v.w):ie.set(v,O,V,k),re.viewport(Y.copy(ie).multiplyScalar(ze).round())},this.getScissor=function(v){return v.copy(Ae)},this.setScissor=function(v,O,V,k){v.isVector4?Ae.set(v.x,v.y,v.z,v.w):Ae.set(v,O,V,k),re.scissor(K.copy(Ae).multiplyScalar(ze).round())},this.getScissorTest=function(){return Fe},this.setScissorTest=function(v){re.setScissorTest(Fe=v)},this.setOpaqueSort=function(v){q=v},this.setTransparentSort=function(v){oe=v},this.getClearColor=function(v){return v.copy(le.getClearColor())},this.setClearColor=function(){le.setClearColor(...arguments)},this.getClearAlpha=function(){return le.getClearAlpha()},this.setClearAlpha=function(){le.setClearAlpha(...arguments)},this.clear=function(v=!0,O=!0,V=!0){let k=0;if(v){let H=!1;if(w!==null){let Me=w.texture.format;H=m.has(Me)}if(H){let Me=w.texture.type,we=p.has(Me),ve=le.getClearColor(),Ce=le.getClearAlpha(),Pe=ve.r,Ze=ve.g,Ke=ve.b;we?(M[0]=Pe,M[1]=Ze,M[2]=Ke,M[3]=Ce,C.clearBufferuiv(C.COLOR,0,M)):(E[0]=Pe,E[1]=Ze,E[2]=Ke,E[3]=Ce,C.clearBufferiv(C.COLOR,0,E))}else k|=C.COLOR_BUFFER_BIT}O&&(k|=C.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),V&&(k|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),k!==0&&C.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),B=v},this.dispose=function(){t.removeEventListener("webglcontextlost",te,!1),t.removeEventListener("webglcontextrestored",Ie,!1),t.removeEventListener("webglcontextcreationerror",Ye,!1),le.dispose(),$.dispose(),Se.dispose(),b.dispose(),z.dispose(),ae.dispose(),ce.dispose(),Z.dispose(),he.dispose(),fe.dispose(),fe.removeEventListener("sessionstart",au),fe.removeEventListener("sessionend",ou),Bi.stop()};function te(v){v.preventDefault(),Gc("WebGLRenderer: Context Lost."),R=!0}function Ie(){Gc("WebGLRenderer: Context Restored."),R=!1;let v=lt.autoReset,O=de.enabled,V=de.autoUpdate,k=de.needsUpdate,H=de.type;be(),lt.autoReset=v,de.enabled=O,de.autoUpdate=V,de.needsUpdate=k,de.type=H}function Ye(v){Oe("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function wt(v){let O=v.target;O.removeEventListener("dispose",wt),ut(O)}function ut(v){Yn(v),b.remove(v)}function Yn(v){let O=b.get(v).programs;O!==void 0&&(O.forEach(function(V){he.releaseProgram(V)}),v.isShaderMaterial&&he.releaseShaderCache(v))}this.renderBufferDirect=function(v,O,V,k,H,Me){O===null&&(O=ye);let we=H.isMesh&&H.matrixWorld.determinant()<0,ve=ep(v,O,V,k,H);re.setMaterial(k,we);let Ce=V.index,Pe=1;if(k.wireframe===!0){if(Ce=ee.getWireframeAttribute(V),Ce===void 0)return;Pe=2}let Ze=V.drawRange,Ke=V.attributes.position,Le=Ze.start*Pe,dt=(Ze.start+Ze.count)*Pe;Me!==null&&(Le=Math.max(Le,Me.start*Pe),dt=Math.min(dt,(Me.start+Me.count)*Pe)),Ce!==null?(Le=Math.max(Le,0),dt=Math.min(dt,Ce.count)):Ke!=null&&(Le=Math.max(Le,0),dt=Math.min(dt,Ke.count));let At=dt-Le;if(At<0||At===1/0)return;ce.setup(H,k,ve,V,Ce);let bt,ft=Je;if(Ce!==null&&(bt=J.get(Ce),ft=rt,ft.setIndex(bt)),H.isMesh)k.wireframe===!0?(re.setLineWidth(k.wireframeLinewidth*He()),ft.setMode(C.LINES)):ft.setMode(C.TRIANGLES);else if(H.isLine){let Ht=k.linewidth;Ht===void 0&&(Ht=1),re.setLineWidth(Ht*He()),H.isLineSegments?ft.setMode(C.LINES):H.isLineLoop?ft.setMode(C.LINE_LOOP):ft.setMode(C.LINE_STRIP)}else H.isPoints?ft.setMode(C.POINTS):H.isSprite&&ft.setMode(C.TRIANGLES);if(H.isBatchedMesh)if(Re.get("WEBGL_multi_draw"))ft.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{let Ht=H._multiDrawStarts,Ee=H._multiDrawCounts,rn=H._multiDrawCount,st=Ce?J.get(Ce).bytesPerElement:1,_n=b.get(k).currentProgram.getUniforms();for(let Un=0;Un<rn;Un++)_n.setValue(C,"_gl_DrawID",Un),ft.render(Ht[Un]/st,Ee[Un])}else if(H.isInstancedMesh)ft.renderInstances(Le,At,H.count);else if(V.isInstancedBufferGeometry){let Ht=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,Ee=Math.min(V.instanceCount,Ht);ft.renderInstances(Le,At,Ee)}else ft.render(Le,At)};function Nn(v,O,V){v.transparent===!0&&v.side===Xt&&v.forceSinglePass===!1?(v.side=Nt,v.needsUpdate=!0,aa(v,O,V),v.side=ei,v.needsUpdate=!0,aa(v,O,V),v.side=Xt):aa(v,O,V)}this.compile=function(v,O,V=null){V===null&&(V=v),T=Se.get(V),T.init(O),x.push(T),V.traverseVisible(function(H){H.isLight&&H.layers.test(O.layers)&&(T.pushLight(H),H.castShadow&&T.pushShadow(H))}),v!==V&&v.traverseVisible(function(H){H.isLight&&H.layers.test(O.layers)&&(T.pushLight(H),H.castShadow&&T.pushShadow(H))}),T.setupLights();let k=new Set;return v.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;let Me=H.material;if(Me)if(Array.isArray(Me))for(let we=0;we<Me.length;we++){let ve=Me[we];Nn(ve,V,H),k.add(ve)}else Nn(Me,V,H),k.add(Me)}),T=x.pop(),k},this.compileAsync=function(v,O,V=null){let k=this.compile(v,O,V);return new Promise(H=>{function Me(){if(k.forEach(function(we){b.get(we).currentProgram.isReady()&&k.delete(we)}),k.size===0){H(v);return}setTimeout(Me,10)}Re.get("KHR_parallel_shader_compile")!==null?Me():setTimeout(Me,10)})};let Ol=null;function jf(v){Ol&&Ol(v)}function au(){Bi.stop()}function ou(){Bi.start()}let Bi=new ef;Bi.setAnimationLoop(jf),typeof self<"u"&&Bi.setContext(self),this.setAnimationLoop=function(v){Ol=v,fe.setAnimationLoop(v),v===null?Bi.stop():Bi.start()},fe.addEventListener("sessionstart",au),fe.addEventListener("sessionend",ou),this.render=function(v,O){if(O!==void 0&&O.isCamera!==!0){Oe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;B!==null&&B.renderStart(v,O);let V=fe.enabled===!0&&fe.isPresenting===!0,k=A!==null&&(w===null||V)&&A.begin(U,w);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),fe.enabled===!0&&fe.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(fe.cameraAutoUpdate===!0&&fe.updateCamera(O),O=fe.getCamera()),v.isScene===!0&&v.onBeforeRender(U,v,O,w),T=Se.get(v,x.length),T.init(O),T.state.textureUnits=_.getTextureUnits(),x.push(T),j.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),De.setFromProjectionMatrix(j,Tn,O.reversedDepth),ke=this.localClippingEnabled,nt=Te.init(this.clippingPlanes,ke),I=$.get(v,L.length),I.init(),L.push(I),fe.enabled===!0&&fe.isPresenting===!0){let we=U.xr.getDepthSensingMesh();we!==null&&Bl(we,O,-1/0,U.sortObjects)}Bl(v,O,0,U.sortObjects),I.finish(),U.sortObjects===!0&&I.sort(q,oe),me=fe.enabled===!1||fe.isPresenting===!1||fe.hasDepthSensing()===!1,me&&le.addToRenderList(I,v),this.info.render.frame++,nt===!0&&Te.beginShadows();let H=T.state.shadowsArray;if(de.render(H,v,O),nt===!0&&Te.endShadows(),this.info.autoReset===!0&&this.info.reset(),(k&&A.hasRenderPass())===!1){let we=I.opaque,ve=I.transmissive;if(T.setupLights(),O.isArrayCamera){let Ce=O.cameras;if(ve.length>0)for(let Pe=0,Ze=Ce.length;Pe<Ze;Pe++){let Ke=Ce[Pe];cu(we,ve,v,Ke)}me&&le.render(v);for(let Pe=0,Ze=Ce.length;Pe<Ze;Pe++){let Ke=Ce[Pe];lu(I,v,Ke,Ke.viewport)}}else ve.length>0&&cu(we,ve,v,O),me&&le.render(v),lu(I,v,O)}w!==null&&W===0&&(_.updateMultisampleRenderTarget(w),_.updateRenderTargetMipmap(w)),k&&A.end(U),v.isScene===!0&&v.onAfterRender(U,v,O),ce.resetDefaultState(),P=-1,F=null,x.pop(),x.length>0?(T=x[x.length-1],_.setTextureUnits(T.state.textureUnits),nt===!0&&Te.setGlobalState(U.clippingPlanes,T.state.camera)):T=null,L.pop(),L.length>0?I=L[L.length-1]:I=null,B!==null&&B.renderEnd()};function Bl(v,O,V,k){if(v.visible===!1)return;if(v.layers.test(O.layers)){if(v.isGroup)V=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(O);else if(v.isLightProbeGrid)T.pushLightProbeGrid(v);else if(v.isLight)T.pushLight(v),v.castShadow&&T.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||De.intersectsSprite(v)){k&&Q.setFromMatrixPosition(v.matrixWorld).applyMatrix4(j);let we=ae.update(v),ve=v.material;ve.visible&&I.push(v,we,ve,V,Q.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||De.intersectsObject(v))){let we=ae.update(v),ve=v.material;if(k&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Q.copy(v.boundingSphere.center)):(we.boundingSphere===null&&we.computeBoundingSphere(),Q.copy(we.boundingSphere.center)),Q.applyMatrix4(v.matrixWorld).applyMatrix4(j)),Array.isArray(ve)){let Ce=we.groups;for(let Pe=0,Ze=Ce.length;Pe<Ze;Pe++){let Ke=Ce[Pe],Le=ve[Ke.materialIndex];Le&&Le.visible&&I.push(v,we,Le,V,Q.z,Ke)}}else ve.visible&&I.push(v,we,ve,V,Q.z,null)}}let Me=v.children;for(let we=0,ve=Me.length;we<ve;we++)Bl(Me[we],O,V,k)}function lu(v,O,V,k){let{opaque:H,transmissive:Me,transparent:we}=v;T.setupLightsView(V),nt===!0&&Te.setGlobalState(U.clippingPlanes,V),k&&re.viewport(Y.copy(k)),H.length>0&&ra(H,O,V),Me.length>0&&ra(Me,O,V),we.length>0&&ra(we,O,V),re.buffers.depth.setTest(!0),re.buffers.depth.setMask(!0),re.buffers.color.setMask(!0),re.setPolygonOffset(!1)}function cu(v,O,V,k){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[k.id]===void 0){let Le=Re.has("EXT_color_buffer_half_float")||Re.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[k.id]=new hn(1,1,{generateMipmaps:!0,type:Le?Gn:en,minFilter:wi,samples:Math.max(4,Ve.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:et.workingColorSpace})}let Me=T.state.transmissionRenderTarget[k.id],we=k.viewport||Y;Me.setSize(we.z*U.transmissionResolutionScale,we.w*U.transmissionResolutionScale);let ve=U.getRenderTarget(),Ce=U.getActiveCubeFace(),Pe=U.getActiveMipmapLevel();U.setRenderTarget(Me),U.getClearColor(pe),ge=U.getClearAlpha(),ge<1&&U.setClearColor(16777215,.5),U.clear(),me&&le.render(V);let Ze=U.toneMapping;U.toneMapping=wn;let Ke=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),T.setupLightsView(k),nt===!0&&Te.setGlobalState(U.clippingPlanes,k),ra(v,V,k),_.updateMultisampleRenderTarget(Me),_.updateRenderTargetMipmap(Me),Re.has("WEBGL_multisampled_render_to_texture")===!1){let Le=!1;for(let dt=0,At=O.length;dt<At;dt++){let bt=O[dt],{object:ft,geometry:Ht,material:Ee,group:rn}=bt;if(Ee.side===Xt&&ft.layers.test(k.layers)){let st=Ee.side;Ee.side=Nt,Ee.needsUpdate=!0,hu(ft,V,k,Ht,Ee,rn),Ee.side=st,Ee.needsUpdate=!0,Le=!0}}Le===!0&&(_.updateMultisampleRenderTarget(Me),_.updateRenderTargetMipmap(Me))}U.setRenderTarget(ve,Ce,Pe),U.setClearColor(pe,ge),Ke!==void 0&&(k.viewport=Ke),U.toneMapping=Ze}function ra(v,O,V){let k=O.isScene===!0?O.overrideMaterial:null;for(let H=0,Me=v.length;H<Me;H++){let we=v[H],{object:ve,geometry:Ce,group:Pe}=we,Ze=we.material;Ze.allowOverride===!0&&k!==null&&(Ze=k),ve.layers.test(V.layers)&&hu(ve,O,V,Ce,Ze,Pe)}}function hu(v,O,V,k,H,Me){v.onBeforeRender(U,O,V,k,H,Me),v.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),H.onBeforeRender(U,O,V,k,v,Me),H.transparent===!0&&H.side===Xt&&H.forceSinglePass===!1?(H.side=Nt,H.needsUpdate=!0,U.renderBufferDirect(V,O,k,H,v,Me),H.side=ei,H.needsUpdate=!0,U.renderBufferDirect(V,O,k,H,v,Me),H.side=Xt):U.renderBufferDirect(V,O,k,H,v,Me),v.onAfterRender(U,O,V,k,H,Me)}function aa(v,O,V){O.isScene!==!0&&(O=ye);let k=b.get(v),H=T.state.lights,Me=T.state.shadowsArray,we=H.state.version,ve=he.getParameters(v,H.state,Me,O,V,T.state.lightProbeGridArray),Ce=he.getProgramCacheKey(ve),Pe=k.programs;k.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?O.environment:null,k.fog=O.fog;let Ze=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;k.envMap=z.get(v.envMap||k.environment,Ze),k.envMapRotation=k.environment!==null&&v.envMap===null?O.environmentRotation:v.envMapRotation,Pe===void 0&&(v.addEventListener("dispose",wt),Pe=new Map,k.programs=Pe);let Ke=Pe.get(Ce);if(Ke!==void 0){if(k.currentProgram===Ke&&k.lightsStateVersion===we)return du(v,ve),Ke}else ve.uniforms=he.getUniforms(v),B!==null&&v.isNodeMaterial&&B.build(v,V,ve),v.onBeforeCompile(ve,U),Ke=he.acquireProgram(ve,Ce),Pe.set(Ce,Ke),k.uniforms=ve.uniforms;let Le=k.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Le.clippingPlanes=Te.uniform),du(v,ve),k.needsLights=np(v),k.lightsStateVersion=we,k.needsLights&&(Le.ambientLightColor.value=H.state.ambient,Le.lightProbe.value=H.state.probe,Le.directionalLights.value=H.state.directional,Le.directionalLightShadows.value=H.state.directionalShadow,Le.spotLights.value=H.state.spot,Le.spotLightShadows.value=H.state.spotShadow,Le.rectAreaLights.value=H.state.rectArea,Le.ltc_1.value=H.state.rectAreaLTC1,Le.ltc_2.value=H.state.rectAreaLTC2,Le.pointLights.value=H.state.point,Le.pointLightShadows.value=H.state.pointShadow,Le.hemisphereLights.value=H.state.hemi,Le.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Le.spotLightMatrix.value=H.state.spotLightMatrix,Le.spotLightMap.value=H.state.spotLightMap,Le.pointShadowMatrix.value=H.state.pointShadowMatrix),k.lightProbeGrid=T.state.lightProbeGridArray.length>0,k.currentProgram=Ke,k.uniformsList=null,Ke}function uu(v){if(v.uniformsList===null){let O=v.currentProgram.getUniforms();v.uniformsList=qs.seqWithValue(O.seq,v.uniforms)}return v.uniformsList}function du(v,O){let V=b.get(v);V.outputColorSpace=O.outputColorSpace,V.batching=O.batching,V.batchingColor=O.batchingColor,V.instancing=O.instancing,V.instancingColor=O.instancingColor,V.instancingMorph=O.instancingMorph,V.skinning=O.skinning,V.morphTargets=O.morphTargets,V.morphNormals=O.morphNormals,V.morphColors=O.morphColors,V.morphTargetsCount=O.morphTargetsCount,V.numClippingPlanes=O.numClippingPlanes,V.numIntersection=O.numClipIntersection,V.vertexAlphas=O.vertexAlphas,V.vertexTangents=O.vertexTangents,V.toneMapping=O.toneMapping}function Qf(v,O){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;S.setFromMatrixPosition(O.matrixWorld);for(let V=0,k=v.length;V<k;V++){let H=v[V];if(H.texture!==null&&H.boundingBox.containsPoint(S))return H}return null}function ep(v,O,V,k,H){O.isScene!==!0&&(O=ye),_.resetTextureUnits();let Me=O.fog,we=k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial?O.environment:null,ve=w===null?U.outputColorSpace:w.isXRRenderTarget===!0?w.texture.colorSpace:et.workingColorSpace,Ce=k.isMeshStandardMaterial||k.isMeshLambertMaterial&&!k.envMap||k.isMeshPhongMaterial&&!k.envMap,Pe=z.get(k.envMap||we,Ce),Ze=k.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,Ke=!!V.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Le=!!V.morphAttributes.position,dt=!!V.morphAttributes.normal,At=!!V.morphAttributes.color,bt=wn;k.toneMapped&&(w===null||w.isXRRenderTarget===!0)&&(bt=U.toneMapping);let ft=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Ht=ft!==void 0?ft.length:0,Ee=b.get(k),rn=T.state.lights;if(nt===!0&&(ke===!0||v!==F)){let mt=v===F&&k.id===P;Te.setState(k,v,mt)}let st=!1;k.version===Ee.__version?(Ee.needsLights&&Ee.lightsStateVersion!==rn.state.version||Ee.outputColorSpace!==ve||H.isBatchedMesh&&Ee.batching===!1||!H.isBatchedMesh&&Ee.batching===!0||H.isBatchedMesh&&Ee.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&Ee.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&Ee.instancing===!1||!H.isInstancedMesh&&Ee.instancing===!0||H.isSkinnedMesh&&Ee.skinning===!1||!H.isSkinnedMesh&&Ee.skinning===!0||H.isInstancedMesh&&Ee.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&Ee.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&Ee.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&Ee.instancingMorph===!1&&H.morphTexture!==null||Ee.envMap!==Pe||k.fog===!0&&Ee.fog!==Me||Ee.numClippingPlanes!==void 0&&(Ee.numClippingPlanes!==Te.numPlanes||Ee.numIntersection!==Te.numIntersection)||Ee.vertexAlphas!==Ze||Ee.vertexTangents!==Ke||Ee.morphTargets!==Le||Ee.morphNormals!==dt||Ee.morphColors!==At||Ee.toneMapping!==bt||Ee.morphTargetsCount!==Ht||!!Ee.lightProbeGrid!=T.state.lightProbeGridArray.length>0)&&(st=!0):(st=!0,Ee.__version=k.version);let _n=Ee.currentProgram;st===!0&&(_n=aa(k,O,H),B&&k.isNodeMaterial&&B.onUpdateProgram(k,_n,Ee));let Un=!1,oi=!1,cs=!1,pt=_n.getUniforms(),Rt=Ee.uniforms;if(re.useProgram(_n.program)&&(Un=!0,oi=!0,cs=!0),k.id!==P&&(P=k.id,oi=!0),Ee.needsLights){let mt=Qf(T.state.lightProbeGridArray,H);Ee.lightProbeGrid!==mt&&(Ee.lightProbeGrid=mt,oi=!0)}if(Un||F!==v){re.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),pt.setValue(C,"projectionMatrix",v.projectionMatrix),pt.setValue(C,"viewMatrix",v.matrixWorldInverse);let ci=pt.map.cameraPosition;ci!==void 0&&ci.setValue(C,se.setFromMatrixPosition(v.matrixWorld)),Ve.logarithmicDepthBuffer&&pt.setValue(C,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&pt.setValue(C,"isOrthographic",v.isOrthographicCamera===!0),F!==v&&(F=v,oi=!0,cs=!0)}if(Ee.needsLights&&(rn.state.directionalShadowMap.length>0&&pt.setValue(C,"directionalShadowMap",rn.state.directionalShadowMap,_),rn.state.spotShadowMap.length>0&&pt.setValue(C,"spotShadowMap",rn.state.spotShadowMap,_),rn.state.pointShadowMap.length>0&&pt.setValue(C,"pointShadowMap",rn.state.pointShadowMap,_)),H.isSkinnedMesh){pt.setOptional(C,H,"bindMatrix"),pt.setOptional(C,H,"bindMatrixInverse");let mt=H.skeleton;mt&&(mt.boneTexture===null&&mt.computeBoneTexture(),pt.setValue(C,"boneTexture",mt.boneTexture,_))}H.isBatchedMesh&&(pt.setOptional(C,H,"batchingTexture"),pt.setValue(C,"batchingTexture",H._matricesTexture,_),pt.setOptional(C,H,"batchingIdTexture"),pt.setValue(C,"batchingIdTexture",H._indirectTexture,_),pt.setOptional(C,H,"batchingColorTexture"),H._colorsTexture!==null&&pt.setValue(C,"batchingColorTexture",H._colorsTexture,_));let li=V.morphAttributes;if((li.position!==void 0||li.normal!==void 0||li.color!==void 0)&&We.update(H,V,_n),(oi||Ee.receiveShadow!==H.receiveShadow)&&(Ee.receiveShadow=H.receiveShadow,pt.setValue(C,"receiveShadow",H.receiveShadow)),(k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial)&&k.envMap===null&&O.environment!==null&&(Rt.envMapIntensity.value=O.environmentIntensity),Rt.dfgLUT!==void 0&&(Rt.dfgLUT.value=fv()),oi){if(pt.setValue(C,"toneMappingExposure",U.toneMappingExposure),Ee.needsLights&&tp(Rt,cs),Me&&k.fog===!0&&X.refreshFogUniforms(Rt,Me),X.refreshMaterialUniforms(Rt,k,ze,je,T.state.transmissionRenderTarget[v.id]),Ee.needsLights&&Ee.lightProbeGrid){let mt=Ee.lightProbeGrid;Rt.probesSH.value=mt.texture,Rt.probesMin.value.copy(mt.boundingBox.min),Rt.probesMax.value.copy(mt.boundingBox.max),Rt.probesResolution.value.copy(mt.resolution)}qs.upload(C,uu(Ee),Rt,_)}if(k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(qs.upload(C,uu(Ee),Rt,_),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&pt.setValue(C,"center",H.center),pt.setValue(C,"modelViewMatrix",H.modelViewMatrix),pt.setValue(C,"normalMatrix",H.normalMatrix),pt.setValue(C,"modelMatrix",H.matrixWorld),k.uniformsGroups!==void 0){let mt=k.uniformsGroups;for(let ci=0,hs=mt.length;ci<hs;ci++){let fu=mt[ci];Z.update(fu,_n),Z.bind(fu,_n)}}return _n}function tp(v,O){v.ambientLightColor.needsUpdate=O,v.lightProbe.needsUpdate=O,v.directionalLights.needsUpdate=O,v.directionalLightShadows.needsUpdate=O,v.pointLights.needsUpdate=O,v.pointLightShadows.needsUpdate=O,v.spotLights.needsUpdate=O,v.spotLightShadows.needsUpdate=O,v.rectAreaLights.needsUpdate=O,v.hemisphereLights.needsUpdate=O}function np(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return G},this.getActiveMipmapLevel=function(){return W},this.getRenderTarget=function(){return w},this.setRenderTargetTextures=function(v,O,V){let k=b.get(v);k.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,k.__autoAllocateDepthBuffer===!1&&(k.__useRenderToTexture=!1),b.get(v.texture).__webglTexture=O,b.get(v.depthTexture).__webglTexture=k.__autoAllocateDepthBuffer?void 0:V,k.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,O){let V=b.get(v);V.__webglFramebuffer=O,V.__useDefaultFramebuffer=O===void 0};let ip=C.createFramebuffer();this.setRenderTarget=function(v,O=0,V=0){w=v,G=O,W=V;let k=null,H=!1,Me=!1;if(v){let ve=b.get(v);if(ve.__useDefaultFramebuffer!==void 0){re.bindFramebuffer(C.FRAMEBUFFER,ve.__webglFramebuffer),Y.copy(v.viewport),K.copy(v.scissor),ne=v.scissorTest,re.viewport(Y),re.scissor(K),re.setScissorTest(ne),P=-1;return}else if(ve.__webglFramebuffer===void 0)_.setupRenderTarget(v);else if(ve.__hasExternalTextures)_.rebindTextures(v,b.get(v.texture).__webglTexture,b.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){let Ze=v.depthTexture;if(ve.__boundDepthTexture!==Ze){if(Ze!==null&&b.has(Ze)&&(v.width!==Ze.image.width||v.height!==Ze.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");_.setupDepthRenderbuffer(v)}}let Ce=v.texture;(Ce.isData3DTexture||Ce.isDataArrayTexture||Ce.isCompressedArrayTexture)&&(Me=!0);let Pe=b.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Pe[O])?k=Pe[O][V]:k=Pe[O],H=!0):v.samples>0&&_.useMultisampledRTT(v)===!1?k=b.get(v).__webglMultisampledFramebuffer:Array.isArray(Pe)?k=Pe[V]:k=Pe,Y.copy(v.viewport),K.copy(v.scissor),ne=v.scissorTest}else Y.copy(ie).multiplyScalar(ze).floor(),K.copy(Ae).multiplyScalar(ze).floor(),ne=Fe;if(V!==0&&(k=ip),re.bindFramebuffer(C.FRAMEBUFFER,k)&&re.drawBuffers(v,k),re.viewport(Y),re.scissor(K),re.setScissorTest(ne),H){let ve=b.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+O,ve.__webglTexture,V)}else if(Me){let ve=O;for(let Ce=0;Ce<v.textures.length;Ce++){let Pe=b.get(v.textures[Ce]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+Ce,Pe.__webglTexture,V,ve)}}else if(v!==null&&V!==0){let ve=b.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,ve.__webglTexture,V)}P=-1},this.readRenderTargetPixels=function(v,O,V,k,H,Me,we,ve=0){if(!(v&&v.isWebGLRenderTarget)){Oe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=b.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&we!==void 0&&(Ce=Ce[we]),Ce){re.bindFramebuffer(C.FRAMEBUFFER,Ce);try{let Pe=v.textures[ve],Ze=Pe.format,Ke=Pe.type;if(v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+ve),!Ve.textureFormatReadable(Ze)){Oe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ve.textureTypeReadable(Ke)){Oe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=v.width-k&&V>=0&&V<=v.height-H&&C.readPixels(O,V,k,H,N.convert(Ze),N.convert(Ke),Me)}finally{let Pe=w!==null?b.get(w).__webglFramebuffer:null;re.bindFramebuffer(C.FRAMEBUFFER,Pe)}}},this.readRenderTargetPixelsAsync=async function(v,O,V,k,H,Me,we,ve=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=b.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&we!==void 0&&(Ce=Ce[we]),Ce)if(O>=0&&O<=v.width-k&&V>=0&&V<=v.height-H){re.bindFramebuffer(C.FRAMEBUFFER,Ce);let Pe=v.textures[ve],Ze=Pe.format,Ke=Pe.type;if(v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+ve),!Ve.textureFormatReadable(Ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ve.textureTypeReadable(Ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Le=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,Le),C.bufferData(C.PIXEL_PACK_BUFFER,Me.byteLength,C.STREAM_READ),C.readPixels(O,V,k,H,N.convert(Ze),N.convert(Ke),0);let dt=w!==null?b.get(w).__webglFramebuffer:null;re.bindFramebuffer(C.FRAMEBUFFER,dt);let At=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await bd(C,At,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,Le),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,Me),C.deleteBuffer(Le),C.deleteSync(At),Me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,O=null,V=0){let k=Math.pow(2,-V),H=Math.floor(v.image.width*k),Me=Math.floor(v.image.height*k),we=O!==null?O.x:0,ve=O!==null?O.y:0;_.setTexture2D(v,0),C.copyTexSubImage2D(C.TEXTURE_2D,V,0,0,we,ve,H,Me),re.unbindTexture()};let sp=C.createFramebuffer(),rp=C.createFramebuffer();this.copyTextureToTexture=function(v,O,V=null,k=null,H=0,Me=0){let we,ve,Ce,Pe,Ze,Ke,Le,dt,At,bt=v.isCompressedTexture?v.mipmaps[Me]:v.image;if(V!==null)we=V.max.x-V.min.x,ve=V.max.y-V.min.y,Ce=V.isBox3?V.max.z-V.min.z:1,Pe=V.min.x,Ze=V.min.y,Ke=V.isBox3?V.min.z:0;else{let Rt=Math.pow(2,-H);we=Math.floor(bt.width*Rt),ve=Math.floor(bt.height*Rt),v.isDataArrayTexture?Ce=bt.depth:v.isData3DTexture?Ce=Math.floor(bt.depth*Rt):Ce=1,Pe=0,Ze=0,Ke=0}k!==null?(Le=k.x,dt=k.y,At=k.z):(Le=0,dt=0,At=0);let ft=N.convert(O.format),Ht=N.convert(O.type),Ee;O.isData3DTexture?(_.setTexture3D(O,0),Ee=C.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(_.setTexture2DArray(O,0),Ee=C.TEXTURE_2D_ARRAY):(_.setTexture2D(O,0),Ee=C.TEXTURE_2D),re.activeTexture(C.TEXTURE0),re.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,O.flipY),re.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),re.pixelStorei(C.UNPACK_ALIGNMENT,O.unpackAlignment);let rn=re.getParameter(C.UNPACK_ROW_LENGTH),st=re.getParameter(C.UNPACK_IMAGE_HEIGHT),_n=re.getParameter(C.UNPACK_SKIP_PIXELS),Un=re.getParameter(C.UNPACK_SKIP_ROWS),oi=re.getParameter(C.UNPACK_SKIP_IMAGES);re.pixelStorei(C.UNPACK_ROW_LENGTH,bt.width),re.pixelStorei(C.UNPACK_IMAGE_HEIGHT,bt.height),re.pixelStorei(C.UNPACK_SKIP_PIXELS,Pe),re.pixelStorei(C.UNPACK_SKIP_ROWS,Ze),re.pixelStorei(C.UNPACK_SKIP_IMAGES,Ke);let cs=v.isDataArrayTexture||v.isData3DTexture,pt=O.isDataArrayTexture||O.isData3DTexture;if(v.isDepthTexture){let Rt=b.get(v),li=b.get(O),mt=b.get(Rt.__renderTarget),ci=b.get(li.__renderTarget);re.bindFramebuffer(C.READ_FRAMEBUFFER,mt.__webglFramebuffer),re.bindFramebuffer(C.DRAW_FRAMEBUFFER,ci.__webglFramebuffer);for(let hs=0;hs<Ce;hs++)cs&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,b.get(v).__webglTexture,H,Ke+hs),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,b.get(O).__webglTexture,Me,At+hs)),C.blitFramebuffer(Pe,Ze,we,ve,Le,dt,we,ve,C.DEPTH_BUFFER_BIT,C.NEAREST);re.bindFramebuffer(C.READ_FRAMEBUFFER,null),re.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(H!==0||v.isRenderTargetTexture||b.has(v)){let Rt=b.get(v),li=b.get(O);re.bindFramebuffer(C.READ_FRAMEBUFFER,sp),re.bindFramebuffer(C.DRAW_FRAMEBUFFER,rp);for(let mt=0;mt<Ce;mt++)cs?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Rt.__webglTexture,H,Ke+mt):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Rt.__webglTexture,H),pt?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,li.__webglTexture,Me,At+mt):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,li.__webglTexture,Me),H!==0?C.blitFramebuffer(Pe,Ze,we,ve,Le,dt,we,ve,C.COLOR_BUFFER_BIT,C.NEAREST):pt?C.copyTexSubImage3D(Ee,Me,Le,dt,At+mt,Pe,Ze,we,ve):C.copyTexSubImage2D(Ee,Me,Le,dt,Pe,Ze,we,ve);re.bindFramebuffer(C.READ_FRAMEBUFFER,null),re.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else pt?v.isDataTexture||v.isData3DTexture?C.texSubImage3D(Ee,Me,Le,dt,At,we,ve,Ce,ft,Ht,bt.data):O.isCompressedArrayTexture?C.compressedTexSubImage3D(Ee,Me,Le,dt,At,we,ve,Ce,ft,bt.data):C.texSubImage3D(Ee,Me,Le,dt,At,we,ve,Ce,ft,Ht,bt):v.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,Me,Le,dt,we,ve,ft,Ht,bt.data):v.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,Me,Le,dt,bt.width,bt.height,ft,bt.data):C.texSubImage2D(C.TEXTURE_2D,Me,Le,dt,we,ve,ft,Ht,bt);re.pixelStorei(C.UNPACK_ROW_LENGTH,rn),re.pixelStorei(C.UNPACK_IMAGE_HEIGHT,st),re.pixelStorei(C.UNPACK_SKIP_PIXELS,_n),re.pixelStorei(C.UNPACK_SKIP_ROWS,Un),re.pixelStorei(C.UNPACK_SKIP_IMAGES,oi),Me===0&&O.generateMipmaps&&C.generateMipmap(Ee),re.unbindTexture()},this.initRenderTarget=function(v){b.get(v).__webglFramebuffer===void 0&&_.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?_.setTextureCube(v,0):v.isData3DTexture?_.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?_.setTexture2DArray(v,0):_.setTexture2D(v,0),re.unbindTexture()},this.resetState=function(){G=0,W=0,w=null,re.reset(),ce.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Tn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=et._getDrawingBufferColorSpace(e),t.unpackColorSpace=et._getUnpackColorSpace()}};var Yt=n=>String(n??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]),si=typeof DIALOGUE<"u"?DIALOGUE:{},Rh=(n,e)=>`<div class="card"><b>${Yt(n)}</b><p>${e}</p></div>`,vf=n=>`<div class="tags">${n.map(e=>`<span class="tag">${Yt(e)}</span>`).join("")}</div>`,yf=Object.entries(SITE.links||{}).filter(([,n])=>n),Mf={github:"GitHub",linkedin:"LinkedIn",twitter:"Twitter / X",resume:"Resume"},Sf=n=>n.replace(/^https?:\/\//,"").replace(/\/$/,""),mv=SITE.showProjects&&PROJECTS.length?PROJECTS.map(n=>Rh(n.title,`${Yt(n.description)}${n.tags?.length?vf(n.tags):""}${[n.repo&&`<a href="${Yt(n.repo)}" target="_blank" rel="noopener">code</a>`,n.demo&&`<a href="${Yt(n.demo)}" target="_blank" rel="noopener">live</a>`].filter(Boolean).join(" \xB7 ")}`)).join(""):'<p class="todo">Nothing on display yet. The screens are warming up.</p>',$s=[{id:"about",tv:"ABOUT",title:"About",say:si.about||[],html:ABOUT},{id:"skills",tv:"SKILLS",title:"Skills",say:si.skills||[],html:vf(SKILLS.flatMap(n=>n.items))+`<ul>${SKILLS.map(n=>`<li><b>${Yt(n.group)}</b> \u2014 ${n.items.map(Yt).join(", ")}</li>`).join("")}</ul>`},{id:"projects",tv:"PROJECTS",title:"Projects",say:si.projects||[],html:mv},{id:"experience",tv:"WORK",title:"Experience",say:si.experience||[],html:(typeof TIMELINE<"u"?TIMELINE:[]).map(n=>Rh(`${n.title}${n.where?" \xB7 "+n.where:""}`,`${Yt(n.when)} \u2014 ${Yt(n.desc||"")}`)).join("")||'<p class="todo">Nothing here yet.</p>'},{id:"education",tv:"SCHOOL",title:"Education",say:si.education||[],html:(typeof EDUCATION<"u"?EDUCATION:[]).map(n=>Rh(`${n.title}${n.where?" \xB7 "+n.where:""}`,`${Yt(n.when||"")} \u2014 ${Yt(n.desc||"")}`)).join("")||'<p class="todo">Nothing here yet.</p>'},{id:"hobbies",tv:"OFF HOURS",title:"Hobbies",say:si.hobbies||[],html:typeof HOBBIES<"u"?HOBBIES:""},{id:"contact",tv:"CONTACT",title:"Contact",say:si.contact||[],html:`<ul>${SITE.email?`<li>Email \u2014 <a href="mailto:${Yt(SITE.email)}">${Yt(SITE.email)}</a></li>`:""}${yf.map(([n,e])=>`<li>${Yt(Mf[n]||n)} \u2014 <a href="${Yt(e)}" target="_blank" rel="noopener">${Yt(Sf(e))}</a></li>`).join("")}</ul>`}],bf=["#15131a","#ece6d2","#c8262b","#e26fb5","#2f5fd8","#f2b632"],Ef=["#141010","#3a2416","#3a6fd8","#2f8a5a","#8a2a3a","#f2b632"],Tf=["#8a8a90","#ece6d2","#1b1b1f","#5a2233","#24463f","#2d3a7a"],gv={name:(SITE.name||"AZAL").toUpperCase().slice(0,14),star:bf[0],pts:5,sharp:.42,face:"eye",eyeC:Ef[0],shirt:Tf[0],top:"tee",extras:[],voice:300},Ue={...gv,...JSON.parse(localStorage.getItem("azal.avatar.v9")||"{}")};Ue.skin=Ue.star;var js=()=>{Ue.skin=Ue.star,localStorage.setItem("azal.avatar.v9",JSON.stringify(Ue))},ts=!1;function wf(n,e){ts=!!e}var zh=document.getElementById("face"),_v=document.getElementById("prev"),na=()=>{Ue.skin=Ue.star,window.buildHead&&buildHead(),Fv()},tt=n=>document.getElementById(n);function gl(n,e,t){n.innerHTML="",e.forEach(i=>{let s=document.createElement("button");s.style.background=i,Ue[t]===i&&s.classList.add("sel"),s.onclick=()=>{Ue[t]=i,js(),na(),gl(n,e,t)},n.appendChild(s)})}function Ch(n,e,t){n.innerHTML="",e.forEach(([i,s])=>{let r=document.createElement("button");r.textContent=s,Ue[t]===i&&r.classList.add("sel"),r.onclick=()=>{Ue[t]=i,js(),na(),Ch(n,e,t)},n.appendChild(r)})}function Af(n,e,t){n.innerHTML="",e.forEach(([i,s])=>{let r=document.createElement("button");r.textContent=s,Ue[t].includes(i)&&r.classList.add("sel"),r.onclick=()=>{Ue[t]=Ue[t].includes(i)?Ue[t].filter(a=>a!==i):[...Ue[t],i],js(),na(),Af(n,e,t)},n.appendChild(r)})}function xv(){gl(tt("cStar"),bf,"star"),gl(tt("cEye"),Ef,"eyeC"),gl(tt("cShirt"),Tf,"shirt"),Ch(tt("cFace"),[["eye","One eye"],["grin","Grin"]],"face"),Ch(tt("cTop"),[["tee","Band tee"],["hoodie","Hoodie"],["sweater","Sweater"]],"top"),Af(tt("cGl"),[["hoops","Hoops"],["frames","Glasses"],["phones","Headphones"],["cap","Cap"]],"extras"),[["cPts","pts"],["cSharp","sharp"]].forEach(([n,e])=>{tt(n).value=Ue[e],tt(n).oninput=t=>{Ue[e]=+t.target.value,js(),na()}}),tt("cVoice").value=Ue.voice,tt("cVoice").oninput=n=>{Ue.voice=+n.target.value,js(),Rf()},tt("cName").value=Ue.name,tt("cName").oninput=n=>{Ue.name=n.target.value.toUpperCase()||"AZAL",js()}}xv();tt("bCust").onclick=()=>{let n=tt("cust").classList.toggle("on");document.body.style.cursor=n?"auto":"none"};var Et=null,ri=!0;function Rf(){if(!ri)return;Et=Et||new(window.AudioContext||window.webkitAudioContext);let n=Et.createOscillator(),e=Et.createGain(),t=Et.currentTime;n.type="square",n.frequency.setValueAtTime(Ue.voice*(.95+Math.random()*.12),t),n.frequency.exponentialRampToValueAtTime(Ue.voice*.8,t+.06),e.gain.setValueAtTime(.06,t),e.gain.exponentialRampToValueAtTime(1e-4,t+.07),n.connect(e).connect(Et.destination),n.start(t),n.stop(t+.08)}ri=localStorage.getItem("azal.sound")!=="off";tt("bSnd").textContent="Sound: "+(ri?"on":"off");tt("bSnd").onclick=()=>{ri=!ri,localStorage.setItem("azal.sound",ri?"on":"off"),tt("bSnd").textContent="Sound: "+(ri?"on":"off")};function vv(){Et=Et||new(window.AudioContext||window.webkitAudioContext);let n=Et.currentTime,e=Et.createBuffer(1,Et.sampleRate*.12,Et.sampleRate),t=e.getChannelData(0);for(let a=0;a<t.length;a++)t[a]=(Math.random()*2-1)*(1-a/t.length);let i=Et.createBufferSource();i.buffer=e;let s=Et.createBiquadFilter();s.type="bandpass",s.frequency.value=1800,s.Q.value=.7;let r=Et.createGain();r.gain.setValueAtTime(.12,n),r.gain.exponentialRampToValueAtTime(1e-4,n+.12),i.connect(s).connect(r).connect(Et.destination),i.start(n)}function yv(){Et=Et||new(window.AudioContext||window.webkitAudioContext);let n=Et.createOscillator(),e=Et.createGain(),t=Et.currentTime;n.type="square",n.frequency.setValueAtTime(1200,t),n.frequency.exponentialRampToValueAtTime(400,t+.05),e.gain.setValueAtTime(.05,t),e.gain.exponentialRampToValueAtTime(1e-4,t+.06),n.connect(e).connect(Et.destination),n.start(t),n.stop(t+.07)}var Ui=tt("dlg"),gh=tt("txt"),_h=tt("more"),yl=[],Js=!1,Ih=null,Cf=null,Ph=null;function kh(n,e){yl=[...n],Ph=e||null,Ui.classList.add("on"),Al()}function Al(){if(Js){clearTimeout(Ih),Js=!1,gh.textContent=dl,Lh(),_h.style.display="block";return}if(!yl.length){Ui.classList.remove("on"),Ph&&Ph();return}dl=yl.shift();let n=0;gh.textContent="",Js=!0,_h.style.display="none";let e=!1;Cf=setInterval(()=>{e=!e,wf(zh,e)},90);let t=()=>{if(!Js)return;let i=dl[n++];gh.textContent+=i,i!==" "&&n%2&&Rf(),n<dl.length?Ih=setTimeout(t,/[.,!?]/.test(i)?160:34):(Js=!1,Lh(),_h.style.display="block")};t()}var dl="";function Lh(){clearInterval(Cf),wf(zh,!1)}Ui.onclick=n=>{n.stopPropagation(),Al()};var Hh=tt("panel"),Mv=tt("pBody"),sn=null,jt=512,In=384,ia=document.createElement("canvas");ia.width=jt;ia.height=In;var Ml=ia.getContext("2d"),Ln=null,Vh=tt("remote"),If=n=>{let e=document.createElement("div");return e.innerHTML=n,(e.textContent||"").replace(/\s+/g," ").trim()},lf=n=>String(n||"").split(/<\/p>|<br\s*\/?>|\n\s*\n/).map(If).filter(Boolean);function Sv(n){let e=[],t=i=>e.push(i);return n.id==="about"?lf(ABOUT).forEach(i=>t({title:"ABOUT",text:i})):n.id==="skills"?SKILLS.forEach(i=>t({title:i.group.toUpperCase(),text:i.items.join("  \xB7  ")})):n.id==="projects"?SITE.showProjects&&PROJECTS.length?PROJECTS.forEach(i=>{t({title:i.title.toUpperCase(),text:i.description||"",sub:(i.tags||[]).join(" \xB7 "),image:i.image,link:i.repo||i.demo,linkLabel:i.repo?"OPEN REPO":"OPEN DEMO"}),(i.walkthrough||[]).forEach(s=>t({title:(s.heading||i.title).toUpperCase(),text:If(s.text||""),image:s.image,link:i.repo||i.demo,linkLabel:i.repo?"OPEN REPO":"OPEN DEMO"}))}):t({title:"NO SIGNAL",text:"Nothing on air yet. Projects go live on this channel once they are ready to be seen."}):n.id==="experience"?(typeof TIMELINE<"u"?TIMELINE:[]).forEach(i=>t({title:String(i.title).toUpperCase(),sub:[i.when,i.where].filter(Boolean).join(" \xB7 "),text:i.desc||""})):n.id==="education"?(typeof EDUCATION<"u"?EDUCATION:[]).forEach(i=>t({title:String(i.title).toUpperCase(),sub:[i.when,i.where].filter(Boolean).join(" \xB7 "),text:i.desc||""})):n.id==="hobbies"?lf(typeof HOBBIES<"u"?HOBBIES:"").forEach(i=>t({title:"OFF HOURS",text:i})):n.id==="contact"&&(SITE.email&&t({title:"EMAIL",text:SITE.email,link:"mailto:"+SITE.email,linkLabel:"SEND MAIL"}),yf.forEach(([i,s])=>t({title:(Mf[i]||i).toUpperCase(),text:Sf(s),link:s,linkLabel:"OPEN"}))),e.length||t({title:n.title.toUpperCase(),text:"Nothing here yet."}),bv(e)}function Pf(n,e,t){let i=[];for(let s of String(e).split(`
`)){let r="";for(let a of s.split(" ")){let o=r?r+" "+a:a;n.measureText(o).width>t&&r?(i.push(r),r=a):r=o}i.push(r)}return i}function bv(n){let e=[];return Ml.font="26px VT323, monospace",n.forEach(t=>{let i=t.image?4:t.sub?9:10,s=Pf(Ml,t.text,jt-48);if(s.length<=i){e.push(t);return}for(let r=0,a=1;r<s.length;r+=i,a++)e.push({...t,text:s.slice(r,r+i).join(" "),image:r?void 0:t.image,sub:r?void 0:t.sub,title:t.title+(r?" ("+a+")":"")})}),e}var xh={};function Ev(n){if(!n)return null;if(!xh[n]){let e=new Image;e.onload=()=>{sn&&Sl()},e.src=n,xh[n]=e}return xh[n]}var qn=[],Dn=0,Pn=null,_l=null;function Sl(){let n=qn[Dn];if(!n)return;let e=Ml;e.fillStyle="#06170b",e.fillRect(0,0,jt,In),e.textBaseline="top",e.textAlign="left",e.fillStyle="#8ef59a",e.font='16px "Press Start 2P", monospace',e.fillText(String(n.title).slice(0,26),24,22);let t=52;n.sub&&(e.fillStyle="#3f9a4d",e.font="20px VT323, monospace",e.fillText(String(n.sub).slice(0,60),24,t),t+=26);let i=Ev(n.image);if(i&&i.complete&&i.naturalWidth){let r=Math.min((jt-48)/i.naturalWidth,150/i.naturalHeight),a=i.naturalWidth*r,o=i.naturalHeight*r;e.drawImage(i,24,t,a,o),t+=o+10}e.fillStyle="#c8ffd0",e.font="26px VT323, monospace",Pf(e,n.text,jt-48).forEach((s,r)=>e.fillText(s,24,t+r*28)),e.fillStyle="#3f9a4d",e.font='11px "Press Start 2P", monospace',n.link&&e.fillText("OK: "+(n.linkLabel||"OPEN"),24,In-26),e.textAlign="right",e.fillText(`${Dn+1}/${qn.length}`,jt-24,In-26),e.fillStyle="rgba(0,0,0,.28)";for(let s=0;s<In;s+=3)e.fillRect(0,s,jt,1);e.fillStyle="rgba(255,255,255,.05)",e.fillRect(16,12,jt-32,18),Ln&&(Ln.needsUpdate=!0)}function Lf(n){clearTimeout(_l);let e=Ml,t=0,i=()=>{let s=e.getImageData(0,0,jt,In);e.putImageData(s,0,0);for(let r=0;r<10;r++){let a=Math.random()*In|0,o=4+Math.random()*24|0,l=Math.random()*60-30|0;e.drawImage(ia,0,a,jt,o,l,a,jt,o)}e.fillStyle="rgba(255,255,255,"+(.25+Math.random()*.5)+")",e.fillRect(0,Math.random()*In|0,jt,2+Math.random()*3|0);for(let r=0;r<400;r++)e.fillStyle=Math.random()<.5?"#000":"#9ff5a8",e.fillRect(Math.random()*jt|0,Math.random()*In|0,2,2);Ln&&(Ln.needsUpdate=!0),++t<5?_l=setTimeout(i,34):(e.fillStyle="#06170b",e.fillRect(0,0,jt,In),e.fillStyle="#c8ffd0",e.fillRect(0,In/2-1,jt,2),Ln&&(Ln.needsUpdate=!0),_l=setTimeout(()=>{n(),ri&&yv()},60))};ri&&vv(),i()}function cf(n){Pn&&Pn!==n&&(Pn.material.map=Pn.userData.cold,Pn.material.needsUpdate=!0),Pn=n,n.material.map=Ln,n.material.needsUpdate=!0,Bh(n,!1)}function jr(n){if(!qn.length)return;let e=(n%qn.length+qn.length)%qn.length;e===Dn&&qn.length>1||Lf(()=>{Dn=e,Sl()})}function Gh(n,e){sn=n,document.body.style.cursor="auto",tt("dot").style.opacity=0,document.pointerLockElement&&document.exitPointerLock(),Mv.innerHTML=`<h2>${n.title}</h2>${n.html}`,tt("hint").style.opacity=0;let t=ss.find(i=>i.userData.section===n);qn=Sv(n),Dn=0,e?Lf(()=>{cf(t),Sl()}):(cf(t),Sl()),Vh.hidden=!1,kh(n.say.map(i=>i.replace(/\{name\}/g,Ue.name)))}function Qr(n){if(!sn)return;let e=$s.indexOf(sn),t=$s[(e+n+$s.length)%$s.length],i=ss.find(s=>s.userData.section===t);su(i,!0),Gh(t,!0)}function Df(){let n=qn[Dn];if(Ui.classList.contains("on")){Al();return}n&&n.link&&window.open(n.link,"_blank","noopener")}function is(){sn=null,document.body.style.cursor="none",tt("dot").style.opacity=.9,typeof ta=="function"&&(ta(),Fl()),Hh.classList.remove("on"),Ui.classList.remove("on"),yl=[],clearTimeout(Ih),Js=!1,Lh(),clearTimeout(_l),Vh.hidden=!0,Pn&&(Pn.material.map=Pn.userData.cold,Pn.material.needsUpdate=!0,Pn=null)}tt("bClose").onclick=is;Vh.addEventListener("click",n=>{let e=n.target.closest("button");if(!e)return;let t=e.dataset.r;t==="power"?is():t==="next"?jr(Dn+1):t==="prev"?jr(Dn-1):t==="chup"?Qr(1):t==="chdn"?Qr(-1):t==="ok"?Df():t==="txt"&&Hh.classList.toggle("on")});addEventListener("keydown",n=>{if(n.key==="Escape"&&is(),!sn){(n.key==="Enter"||n.key===" ")&&Ui.classList.contains("on")&&Al();return}n.key==="ArrowRight"?(n.preventDefault(),jr(Dn+1)):n.key==="ArrowLeft"?(n.preventDefault(),jr(Dn-1)):n.key==="ArrowUp"?(n.preventDefault(),Qr(-1)):n.key==="ArrowDown"?(n.preventDefault(),Qr(1)):n.key==="Enter"||n.key===" "?(n.preventDefault(),Df()):(n.key==="t"||n.key==="T")&&Hh.classList.toggle("on")});var ea=tt("gl"),sa;try{sa=new Ys({canvas:ea,antialias:!1,powerPreference:"high-performance",logarithmicDepthBuffer:!0})}catch(n){throw console.error("WebGL unavailable",n),document.getElementById("nogl").hidden=!1,n}sa.setPixelRatio(1);sa.outputColorSpace=Lt;var ht=new Ls;ht.background=new qe(659228);ht.fog=new fr(659228,.05);var Cn=new Dt(62,1,.2,120),Rl=new D(0,1.18,1.7);Cn.position.copy(Rl);var Zr=300,xl=400;function Nf(){let n=innerWidth,e=innerHeight;Zr=300,xl=Math.round(Zr*n/e),sa.setSize(xl,Zr,!1),window.snapRes&&Wh.value.set(xl,Zr),Cn.aspect=n/e,Cn.updateProjectionMatrix()}addEventListener("resize",Nf);Nf();var Tv=`#include <project_vertex>
  vec2 grid=uSnapRes*0.5;
  gl_Position.xy = floor(gl_Position.xy/gl_Position.w*grid+0.5)/grid*gl_Position.w;`,Wh={value:new ue(xl,Zr)};window.snapRes=Wh;function Fi(n){return n.onBeforeCompile=e=>{e.uniforms.uSnapRes=Wh,e.vertexShader=`uniform vec2 uSnapRes;
`+e.vertexShader.replace("#include <project_vertex>",Tv)},n}var Tt=(n,e={})=>Fi(new fn({color:n,...e})),Oi=(n,e={})=>Fi(new fn({map:n,...e}));function nn(n,e,t,i){let s=document.createElement("canvas");s.width=n,s.height=e,t(s.getContext("2d"),n,e);let r=new Us(s);return r.magFilter=r.minFilter=Ct,r.colorSpace=Lt,i&&(r.wrapS=r.wrapT=Ts,r.repeat.set(i[0],i[1])),r}var it=(n,e)=>n+Math.random()*(e-n),Jr=(n,e,t,i,s)=>{for(let r=0;r<i;r++)n.fillStyle=`rgba(${s},${s},${s},${it(.05,.25)})`,n.fillRect(it(0,e)|0,it(0,t)|0,it(1,3)|0,it(1,3)|0)},ai={wood:nn(64,64,(n,e,t)=>{n.fillStyle="#4a3424",n.fillRect(0,0,e,t);for(let i=0;i<t;i+=16)n.fillStyle=["#5a4030","#523826","#63472f","#473020"][i/16%4],n.fillRect(0,i,e,15),n.fillStyle="#2a1a10",n.fillRect(0,i+15,e,1),n.fillRect(it(0,e)|0,i,1,15);Jr(n,e,t,120,0)},[4,3]),ceil:nn(64,64,(n,e,t)=>{for(let i=0;i<e;i+=8)n.fillStyle=i%16?"#4f5560":"#2e333b",n.fillRect(i,0,8,t);n.fillStyle="#6b4d34";for(let i=0;i<14;i++)n.fillRect(it(0,e)|0,it(0,t)|0,it(2,8)|0,it(2,6)|0);Jr(n,e,t,150,0)},[6,4]),wall:nn(64,64,(n,e,t)=>{n.fillStyle="#3a3238",n.fillRect(0,0,e,t);for(let i=0;i<t;i+=8)for(let s=0;s<e;s+=16)n.fillStyle=Math.random()<.5?"#463a40":"#332a30",n.fillRect(s+(i/8%2?8:0),i,15,7);Jr(n,e,t,200,0),n.fillStyle="rgba(20,60,30,.35)",n.fillRect(0,t-20,e,20)},[5,2]),rug:nn(64,48,(n,e,t)=>{n.fillStyle="#5a1f26",n.fillRect(0,0,e,t),n.fillStyle="#8a3a30",n.fillRect(4,4,e-8,t-8),n.fillStyle="#5a1f26",n.fillRect(8,8,e-16,t-16),n.fillStyle="#c9a35a";for(let i=12;i<e-12;i+=8)for(let s=12;s<t-12;s+=8)n.fillRect(i,s,3,3),n.fillRect(i+4,s+4,2,2);n.fillStyle="#2b3f5a",n.fillRect(e/2-6,t/2-6,12,12),Jr(n,e,t,160,0)}),sky:nn(256,128,(n,e,t)=>{let i=n.createLinearGradient(0,0,0,t);i.addColorStop(0,"#05070f"),i.addColorStop(1,"#1b2440"),n.fillStyle=i,n.fillRect(0,0,e,t),n.fillStyle="#fff";for(let s=0;s<140;s++)n.fillRect(it(0,e)|0,it(0,t*.8)|0,1,1);n.fillStyle="#e9e6d8",n.beginPath(),n.arc(200,26,9,0,7),n.fill(),n.fillStyle="#b9b6a8",n.fillRect(197,24,3,3)}),speaker:nn(32,32,(n,e,t)=>{n.fillStyle="#161618",n.fillRect(0,0,e,t),n.fillStyle="#2a2a2e";for(let i=0;i<t;i+=2)n.fillRect(0,i,e,1);n.fillStyle="#0a0a0c",n.beginPath(),n.arc(16,20,9,0,7),n.fill(),n.fillStyle="#3a3a40",n.beginPath(),n.arc(16,20,4,0,7),n.fill(),n.fillStyle="#0a0a0c",n.beginPath(),n.arc(16,7,4,0,7),n.fill()}),paper:nn(16,16,n=>{n.fillStyle="#d8d2bd",n.fillRect(0,0,16,16),n.fillStyle="#6a6a6a";for(let e=3;e<14;e+=3)n.fillRect(2,e,it(6,12)|0,1)}),cash:nn(16,8,n=>{n.fillStyle="#7a9a5a",n.fillRect(0,0,16,8),n.fillStyle="#4a6a3a",n.fillRect(1,1,14,6),n.fillStyle="#a9c98a",n.fillRect(6,2,4,4)})};function bl(n,e,t){return nn(128,96,(i,s,r)=>{i.fillStyle=t?"#0f3a1a":"#06170b",i.fillRect(0,0,s,r),i.fillStyle=t?"#c8ffd0":"#7ff28f",i.font='bold 16px "Press Start 2P", monospace',i.textAlign="center",i.textBaseline="middle",i.fillText(n,s/2,r/2-6),i.font="16px VT323, monospace",i.fillStyle=t?"#9fe8a8":"#3f9a4d",i.fillText(e,s/2,r/2+18),i.fillStyle="rgba(0,0,0,.35)";for(let a=0;a<r;a+=2)i.fillRect(0,a,s,1);i.fillStyle="rgba(255,255,255,.08)",i.fillRect(6,6,s-12,10)})}function vh(n,e,t){return nn(64,40,(i,s,r)=>{i.fillStyle=t,i.fillRect(0,0,s,r),i.fillStyle=e,i.fillRect(2,2,s-4,r-4),i.fillStyle=t,i.font='bold 10px "Press Start 2P", monospace',i.textAlign="center",i.textBaseline="middle";let a=n.split(`
`);a.forEach((o,l)=>i.fillText(o,s/2,r/2+(l-(a.length-1)/2)*12)),Jr(i,s,r,60,0)})}var _t=(n,e,t,i,s,r,a,o)=>{let l=new _e(new ot(n,e,t),i);return l.position.set(s,r,a),l.name=o||"",ht.add(l),l},Qt={w:8.5,d:7,h:3.1},Xh=new _e(new Kt(Qt.w,Qt.d,17,14),Oi(ai.wood));Xh.rotation.x=-Math.PI/2;Xh.position.z=-.5;ht.add(Xh);var qh=new _e(new Kt(Qt.w,Qt.d,17,14),Oi(ai.ceil));qh.rotation.x=Math.PI/2;qh.position.set(0,Qt.h,-.5);ht.add(qh);var Yh=Oi(ai.wall),Cl=new _e(new Kt(Qt.d,Qt.h,14,6),Yh);Cl.rotation.y=Math.PI/2;Cl.position.set(-Qt.w/2,Qt.h/2,-.5);ht.add(Cl);var Zh=Cl.clone();Zh.rotation.y=-Math.PI/2;Zh.position.x=Qt.w/2;ht.add(Zh);var Jh=new _e(new Kt(Qt.w,Qt.h,17,6),Yh);Jh.position.set(0,Qt.h/2,3);Jh.rotation.y=Math.PI;ht.add(Jh);_t(Qt.w,1,.2,Yh,0,.5,-4);var Il=Tt(5921378);_t(Qt.w,.06,.06,Il,0,1.55,-4);for(let n=-4;n<=4;n+=1)_t(.05,.55,.05,Il,n,1.28,-4);var $h=new _e(new Kt(5.2,4.4,13,11),Oi(ai.rug));$h.rotation.x=-Math.PI/2;$h.position.set(0,.02,-.4);var Uf=new _e(new ot(5.2,.02,4.4),Tt(4856352));Uf.position.set(0,.01,-.4);ht.add(Uf);ht.add($h);var Ff=new _e(new Kt(160,80),new $t({map:ai.sky,fog:!1}));Ff.position.set(0,20,-60);ht.add(Ff);var hf=Tt(1185831),wv=new $t({color:14271098,fog:!0});[[-9,-16,2.2,9],[5,-20,3,12],[-3,-26,4,7],[12,-24,2.5,10],[-15,-22,3.5,6]].forEach(([n,e,t,i])=>{_t(t,i,t,hf,n,i/2-2,e);for(let s=0;s<5;s++){let r=_t(.35,.5,.05,wv,n+it(-t/2+.3,t/2-.3),it(.5,i-3),e+t/2+.03)}_t(.3,i+3,.3,hf,n-t/2-.5,(i+3)/2-2,e-1)});var ib=Tt(9075290);_t(.02,1.1,.02,Il,2.5,2.55,-.6);var Of=new _e(new kt(.16,.34,.26,10,1,!0),Fi(new fn({color:3095103,side:Xt})));Of.position.set(2.5,1.98,-.6);ht.add(Of);var Kh=new _e(new yi(.06,8,6),new $t({color:16769704}));Kh.position.set(2.5,1.93,-.6);ht.add(Kh);ht.add(new Nr(2765904,1.6));var El=new Ei(16758890,14,10,2);El.position.set(2.5,1.9,-.6);ht.add(El);var jh=new Ei(6094726,6,7,2);jh.position.set(0,1.2,-1.6);ht.add(jh);var vl=new Ei(6094726,0,4,2);ht.add(vl);var Bf=new Ji(7311305,.9);Bf.position.set(-2,4,-8);ht.add(Bf);var zf=Oi(ai.wood);_t(4.8,.07,.95,zf,0,.78,-2.05);[[-2.3,-2.45],[2.3,-2.45],[-2.3,-1.65],[2.3,-1.65]].forEach(([n,e])=>_t(.08,.75,.08,Tt(2825234),n,.375,e));_t(4.4,.05,.5,zf,0,1.75,-2.35);[[-1.9],[0],[1.9]].forEach(([n])=>_t(.06,.5,.4,Tt(2825234),n,1.5,-2.4));var Pi=Tt(2894897),kf=Tt(3815219),Hf=Tt(2435118),ss=[];function rs(n,e,t,i,s,r,a,o){let l=new ln;l.position.set(s,r,a);let c=new _e(new ot(e,t,i),o);c.name="tv_"+n.id,l.add(c);let u=new _e(new ot(e*.7,t*.7,i*.35),o);u.position.z=-i/2-i*.17,l.add(u);let d=new _e(new ot(e*.86,t*.8,.02),Tt(855312));d.position.set(0,t*.06,i/2+.005),l.add(d);let h=bl(n.tv,n.title.toUpperCase(),!1),f=bl(n.tv,"> OPEN",!0),g=new $t({map:h,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-2}),y=new _e(new Kt(e*.78,t*.7),g);y.position.set(0,t*.06,i/2+.02),y.userData={section:n,cold:h,hot:f},y.name="screen_"+n.id,l.add(y),ss.push(y);let m=new _e(new kt(.03,.03,.02,8),Tt(1911));m.rotation.x=Math.PI/2,m.position.set(e*.36,-t*.38,i/2+.01),l.add(m);let p=m.clone();return p.position.x=e*.28,l.add(p),l.rotation.y=it(-.08,.08),ht.add(l),l}var as=Object.fromEntries($s.map(n=>[n.id,n]));rs(as.about,.95,.78,.7,-1.75,.815+.39,-2.1,Pi);rs(as.projects,1.15,.9,.8,-.5,.815+.45,-2.05,kf);rs(as.skills,.95,.78,.7,.75,.815+.39,-2.1,Hf);rs(as.contact,.8,.66,.6,1.8,.815+.33,-2.15,Pi);rs(as.experience,.85,.7,.6,-1.2,1.775+.35,-2.4,kf);rs(as.education,.85,.7,.6,.15,1.775+.35,-2.4,Pi);rs(as.hobbies,.75,.62,.55,1.35,1.775+.31,-2.45,Hf);var Qh=Oi(ai.speaker);_t(.5,1.45,.45,Qh,-3.1,.725,-2.1);_t(.5,1.45,.45,Qh,3.1,.725,-2.1);_t(.36,.5,.35,Qh,-3.1,1.7,-2.1);var Av=Tt(1710622);[[[-4.2,2.4,-3.9],[-1.5,2,-2.5],[2.5,2.9,-.6]],[[4.2,2.6,-3.9],[2.6,2.15,-2.2],[2.5,2.95,-.6]],[[-4.2,2.9,1],[0,2.5,-1.5],[4.2,2.8,-3.5]]].forEach(n=>{let e=new Bs(n.map(t=>new D(...t)));ht.add(new _e(new Ir(e,16,.018,5),Av))});_t(.08,3,.08,Il,3.3,1.5,-3.6);[[vh(`NO
SIGNAL`,"#e2b23c","#1a1a1a"),1.45,.3],[vh(`STAY
SEATED`,"#e6e2d6","#a3231f"),2.05,-.2],[vh("CCTV","#d9d9d9","#1f2a5a"),2.55,.15]].forEach(([n,e,t])=>{let i=new _e(new ot(.62,.4,.03),[Pi,Pi,Pi,Pi,Oi(n),Pi]);i.position.set(3.3,e,-3.55),i.rotation.y=t,ht.add(i)});for(let n=0;n<14;n++){let e=new _e(new Kt(.22,.28),Oi(n%3?ai.paper:ai.cash,{side:Xt,polygonOffset:!0,polygonOffsetFactor:-4,polygonOffsetUnits:-4}));e.rotation.set(-Math.PI/2,0,it(0,6.3)),e.position.set(it(-3,3),.045+n*.002,it(-1.4,1.6)),ht.add(e)}for(let n=0;n<4;n++){let e=new _e(new kt(.045,.045,.14,8),Tt([13123632,3170496,13684944,3186768][n]));e.position.set(it(-2.5,2.5),.07,it(-1.2,1.4)),e.rotation.z=n%2?Math.PI/2:0,n%2&&(e.position.y=.045),ht.add(e)}var Rv=[],uf=Tt(14735560),Cv=new $t({color:2758152});function Pl(n,e,t,i,s){let r=new ln;r.position.set(n,e,t),r.rotation.y=i;let a=new _e(new kt(.06,.052,.13,10,1,!0),Fi(new fn({color:14735560,side:Xt})));r.add(a);let o=new _e(new Fs(.052,10),uf);o.rotation.x=Math.PI/2,o.position.y=-.064,r.add(o);let l=new _e(new Fs(.057,10),Cv);l.rotation.x=-Math.PI/2,l.position.y=s?.045:-.03,r.add(l);let c=new _e(new Hn(.035,.01,4,8,Math.PI),uf);return c.position.set(.065,0,0),c.rotation.z=-Math.PI/2,r.add(c),ht.add(r),r}Pl(2.15,.88,-1.75,.4,!0);Pl(-2.3,.88,-1.7,-1.2,!1);Pl(-.15,.88,-1.62,2,!1);Pl(2.55,.085,.9,1.1,!1);for(let n=0;n<3;n++){let e=new _e(new kt(.045,.035,.1,8,1,!0),Fi(new fn({color:14275782,side:Xt})));e.position.set(1.05+n*.02,.87+n*.035,-1.68),ht.add(e)}var Iv=Fi(new fn({color:15764e3,emissive:6959104,emissiveIntensity:.5,transparent:!0,opacity:.9})),Pv=Tt(15921902),Lv=nn(32,16,n=>{n.fillStyle="#f4f1e8",n.fillRect(0,0,32,16),n.fillStyle="#333";for(let e=3;e<13;e+=3)n.fillRect(3,e,it(12,24)|0,1);n.fillStyle="#c0392b",n.fillRect(3,1,8,1)});function os(n,e,t,i){let s=new ln;s.position.set(n,e,t);let r=new _e(new kt(.035,.035,.11,10),Iv);s.add(r);let a=new _e(new kt(.036,.036,.06,10,1,!0),Fi(new fn({map:Lv,side:Xt})));a.position.y=-.005,s.add(a);let o=new _e(new kt(.037,.037,.025,10),Pv);o.position.y=.067,s.add(o),i?(s.rotation.z=Math.PI/2,s.rotation.y=it(0,6.3),s.position.y=e-.02):s.rotation.y=it(0,6.3);let l=new _e(new kt(.042,.042,.15,10),new $t({color:2783806,transparent:!0,opacity:.2,depthWrite:!1,blending:$i,side:Nt}));return l.position.y=.01,s.add(l),ht.add(s),s}os(.35,.87,-1.65,!1);os(.45,.87,-1.72,!1);os(-1.05,.87,-1.62,!0);os(1.6,.87,-1.6,!1);os(2.2,.06,-.4,!0);os(-2.9,.07,.6,!1);var Dv=nn(16,8,n=>{n.fillStyle="#f28c28",n.fillRect(0,0,16,8),n.fillStyle="#c96a10",n.fillRect(0,6,16,2),n.fillStyle="#7a3a05",n.fillRect(7,1,2,6),n.fillRect(6,2,1,4),n.fillRect(9,2,1,4),n.fillRect(6,4,4,1)}),Nv=Fi(new fn({map:Dv,emissive:5908992,emissiveIntensity:.6})),Vf=new yi(.022,8,6);Vf.scale(1.6,.7,1);function Ll(n,e,t){let i=new _e(Vf,Nv);return i.position.set(n,e,t),i.rotation.set(it(-.3,.3),it(0,6.3),it(-.3,.3)),ht.add(i),Rv.push(i),i}for(let n=0;n<9;n++)Ll(-1.05+it(-.25,.15),.826,-1.62+it(-.15,.2));for(let n=0;n<4;n++)Ll(.4+it(-.1,.15),.826,-1.7+it(-.08,.12));for(let n=0;n<14;n++)Ll(-.9+it(-.5,1.6),.036,-1.5+it(-.3,.55));for(let n=0;n<6;n++)Ll(-.4+it(-.4,.6),.036,-.7+it(-.2,.3));os(-.35,.06,-1.25,!0);var Uv=[[-1.1,.83,-1.6,.5],[-.2,.02,-1.3,1.1],[.42,.83,-1.68,.3],[-.3,.02,-.65,.6]].map(([n,e,t,i])=>{let s=new _e(new yi(i,6,4),new $t({visible:!1}));return s.position.set(n,e,t),ht.add(s),s}),Gf=Tt(2761504),sb=_t(.12,.08,.7,Gf,-.36,.74,1.65,"armrest"),rb=_t(.12,.08,.7,Gf,.36,.74,1.65,"armrest");_t(.7,.05,.04,Tt(3811866),0,.72,1.25,"strap");var mn={};function Fv(){let n=new qe(Ue.skin),e=new qe(Ue.shirt),t=new qe(Ue.shirt).multiplyScalar(.55);mn.built?(mn.skinM.color.copy(n),mn.shirtM.color.copy(e),mn.pantsM.color.copy(t)):(mn.skinM=Tt(n),mn.shirtM=Tt(e),mn.pantsM=Tt(t),[-1,1].forEach(i=>{_t(.17,.16,.62,mn.pantsM,i*.17,.62,1.35,"thigh"),_t(.15,.55,.15,mn.pantsM,i*.17,.3,1.05,"shin"),_t(.16,.08,.28,Tt(1381653),i*.17,.04,.97,"shoe"),_t(.11,.11,.5,mn.shirtM,i*.36,.83,1.75,"forearm"),_t(.11,.07,.16,mn.skinM,i*.36,.81,1.45,"hand"),_t(.15,.03,.04,Tt(3811866),i*.36,.86,1.5,"wriststrap")}),_t(.44,.3,.24,mn.shirtM,0,.9,1.78,"torso"),mn.built=!0)}var ns=document.createElement("canvas");ns.width=ns.height=200;var Dl=new Ys({canvas:ns,antialias:!1,alpha:!0});Dl.setPixelRatio(1);Dl.setSize(200,200,!1);Dl.outputColorSpace=Lt;var Ni=new Ls,eu=new Dt(30,1,.1,20);eu.position.set(.25,-.15,4.7);eu.lookAt(0,-.5,0);Ni.add(new Lr(12107992,4864576,2.2));var Wf=new Ji(16767152,3.2);Wf.position.set(-3,4,5);Ni.add(Wf);var Xf=new Ji(16771280,1.6);Xf.position.set(2,.5,6);Ni.add(Xf);var qf=new Ei(6094726,3,6,2);qf.position.set(-2,-.5,2);Ni.add(qf);var Ov=`#include <project_vertex>
  vec2 hgrid=vec2(150.0,150.0);
  gl_Position.xy = floor(gl_Position.xy/gl_Position.w*hgrid)/hgrid*gl_Position.w;`,Mt=n=>{let e=new fn(n);return e.onBeforeCompile=t=>{t.vertexShader=t.vertexShader.replace("#include <project_vertex>",Ov)},e};var Tl=2.9,Ks=128,tn=n=>Math.round((n/Tl+.5)*Ks),yh=n=>Math.round((.5-n/Tl)*Ks);function Mh(n,e){return nn(Ks,Ks,t=>{t.imageSmoothingEnabled=!1;let i=new qe(Ue.star),s=i.getHSL({}).l<.4,r="#"+i.getHexString(),a=s?"#f2eee4":"#15100f",o=Ue.eyeC,l=(c,u,d,h=1,f=1)=>{t.fillStyle=c,t.fillRect(u,d,h,f)};if(l(r,0,0,Ks,Ks),Ue.face==="eye"){let c=tn(0),u=yh(-.02),d=26,h=18,f=c-d/2,g=u-h/2;e?l(a,f,u-1,d,2):(l(a,f,g,d,h),l(a,f-2,g+3,2,h-6),l(a,f+d,g+3,2,h-6),l(r,f,g,d,3),l(r,f-2,g+3,2,1),l(r,f+d,g+3,2,1),l(o,c-6,g+4,12,h-5),l("#000",c-3,g+6,6,h-8),l("#fff",c-5,g+5,2,2))}else{let c=yh(.25);[-.32,.32].forEach(h=>{let f=tn(h);l(a,f-8,c-1,16,3),l(a,f-10,c-3,3,2),l(a,f+8,c-3,3,2)});let u=yh(-.05),d=14;l(a,tn(-.7),u,tn(.7)-tn(-.7),d),l(s?"#15131a":"#f4f2ea",tn(-.66),u+3,tn(.66)-tn(-.66),d-6);for(let h=1;h<8;h++)l(a,tn(-.66)+h*((tn(.66)-tn(-.66))/8|0),u+3,1,d-6);l(a,tn(-.66),u+3+((d-6)/2|0),tn(.66)-tn(-.66),1)}})}var It=null,df,ff,pf,Bv,St=null,zv=1.1;function kv(n,e,t){let i=t,s=()=>(i=i*16807%2147483647,(i-1)/2147483646),r=new qi,a=-.22;for(let o=0;o<n*2;o++){let l=o/(n*2)*Math.PI*2+Math.PI/2+a+(s()-.5)*.28,c=zv*(o%2===0?.82+s()*.42:e*(.8+s()*.35)),u=Math.cos(l)*c,d=Math.sin(l)*c;o?r.lineTo(u,d):r.moveTo(u,d)}return r.closePath(),r}window.buildHead=function(){St&&Ni.remove(St),St=new ln,It=new ln,St.add(It),df=Mh(!1),ff=Mh(!0),pf=Mh(!1,!0),[df,ff,pf].forEach(w=>{w.wrapS=w.wrapT=vn,w.repeat.set(1/Tl,1/Tl),w.offset.set(.5,.5)});let n=new qe(Ue.star),e=Mt({color:n}),t=Mt({color:n.clone().offsetHSL(0,0,n.getHSL({}).l<.4?.08:-.12)}),i=Mt({color:1118481}),s=Mt({color:14211298}),r=Mt({color:10132134}),a=Mt({color:Ue.shirt}),o=Mt({color:new qe(Ue.shirt).offsetHSL(0,0,.14)});Bv=e;let l=kv(Ue.pts,Ue.sharp,Ue.pts*13+Math.round(Ue.sharp*100)),c=new Rr(l,{depth:.2,bevelEnabled:!0,bevelThickness:.02,bevelSize:.02,bevelSegments:1});c.translate(0,0,-.1);let u=new _e(c,[e,t]);u.name="star",It.add(u);let d=n.getHSL({}).l<.4?15920868:1380367,h=Mt({color:d}),f=Mt({color:Ue.eyeC}),g=Mt({color:0}),y=Mt({color:16777215}),m=(w,P,F,Y,K,ne,pe)=>{let ge=new _e(new Kt(w,P),ne);return ge.position.set(F,Y,K),ge.name=pe||"",It.add(ge),ge},p=.125;if(window.__eye=[],Ue.face==="eye"){__eye.push(m(.56,.3,0,-.05,p,h,"eyewhite")),m(.6,.07,0,-.05+.13,p+.002,e,"lid"),__eye.push(m(.24,.22,.02,-.05-.02,p+.003,f,"iris")),__eye.push(m(.12,.14,.02,-.05-.03,p+.005,g,"pupil")),__eye.push(m(.05,.05,-.04,-.05+.03,p+.007,y,"glint")),window.__blinkQuad=m(.56,.05,0,-.05,p+.01,h,"blink"),__blinkQuad.visible=!1;let P=Mt({color:n.getHSL({}).l<.4?9078416:5913156});m(.5,.025,.01,-.05-.19,p+.002,P,"bag1"),m(.36,.02,.03,-.05-.24,p+.002,P,"bag2"),[-1,1].forEach(F=>m(.03,.05,F*.25,-.05-.17,p+.002,P))}else{let w=window.__brows=[],P=.22;[-.24,.24].forEach(q=>{let oe=q<0?1:-1;for(let Ae=0;Ae<3;Ae++){let Fe=q+(Ae-1)*.075,De=P+.11-Ae*oe*.025,nt=m(.078,.032,Fe,De,p,h,"brow");w.push({mesh:nt,bx:Fe,by:De,side:oe,k:Ae})}let ie=m(.22,.035,q,P,p+.001,h,"slit");w.push({mesh:ie,bx:q,by:P,side:oe,k:-1}),m(.04,.03,q+oe*-.04,P,p+.004,e,"gleam")});let F=n.getHSL({}).l<.4?16052970:1381146,Y=Mt({color:F}),K=window.__grinSegs=[],ne=window.__grinTeeth=[],pe=window.__grinDivs=[],ge=18,Be=1.05,je=-.16,ze=Be/ge;for(let q=0;q<ge;q++){let oe=q/(ge-1),ie=-Be/2+ze/2+oe*Be;K.push({mesh:m(ze*1.2,.14,ie,je,p+5e-4,h,"grin"),t:oe,x:ie}),ne.push({mesh:m(ze*.95,.07,ie,je,p+.003,Y,"tooth"),t:oe,x:ie})}for(let q=1;q<8;q++){let oe=q/8,ie=-Be/2+oe*Be;pe.push({mesh:m(.018,.07,ie,je,p+.005,h,"div"),t:oe,x:ie})}window.__grinBase={GY:je,GW:Be}}let M=new _e(new Cr(l),e);M.position.z=-.125,M.rotation.y=Math.PI,It.add(M);let S=l.getPoints(1).filter((w,P)=>P%2===0&&P<Ue.pts*2).map(w=>new ue(w.x,w.y)),T=(w=>S.slice().sort(w))((w,P)=>P.y-P.x-(w.y-w.x))[0],L=S.filter(w=>w.x<0).sort((w,P)=>P.y-w.y),x=S.filter(w=>w.x>0).sort((w,P)=>P.y-w.y),A=[L[Math.min(1,L.length-1)],x[Math.min(1,x.length-1)]].filter(Boolean),U=n.getHSL({}).l<.4?r:i;A.forEach(w=>{let P=new _e(new ot(.08,.08,.06),U);P.position.set(w.x*.8,w.y*.8,.13),It.add(P)});{let w=T.clone().normalize(),P=new ue(-w.y,w.x),F=T.clone().multiplyScalar(.72),Y=new _e(new kt(.028,.028,.7,6),r);Y.position.set(F.x,F.y,0),Y.rotation.z=Math.atan2(P.y,P.x)+Math.PI/2,It.add(Y),[-1,1].forEach(K=>{let ne=new _e(new yi(.07,6,5),s);ne.position.set(F.x+P.x*.35*K,F.y+P.y*.35*K,0),It.add(ne)})}let R=Ue.extras||[];if(R.includes("hoops")&&A.forEach(w=>{let P=new _e(new Hn(.11,.015,6,12),s);P.position.set(w.x*.98,w.y*.98-.1,0),P.rotation.y=Math.PI/2,It.add(P)}),R.includes("frames"))if(Ue.face==="eye"){let w=new _e(new Hn(.4,.03,6,16),i);w.position.set(0,-.05,.14),It.add(w)}else{[-.32,.32].forEach(P=>{let F=new _e(new Hn(.24,.03,6,16),i);F.position.set(P,.25,.2),It.add(F)});let w=new _e(new ot(.2,.04,.04),i);w.position.set(0,.25,.2),It.add(w)}if(R.includes("phones")){let w=Mt({color:14210252}),P=Mt({color:2763310}),F=new _e(new Hn(1.05,.05,4,12,Math.PI),w);It.add(F),[-1,1].forEach(Y=>{let K=new _e(new kt(.22,.22,.16,8),w);K.rotation.z=Math.PI/2,K.position.set(Y*1.02,0,0),It.add(K);let ne=new _e(new kt(.17,.17,.06,8),P);ne.rotation.z=Math.PI/2,ne.position.set(Y*.92,0,0),It.add(ne)})}if(R.includes("cap")){let w=Mt({color:12872314}),P=new _e(new ot(.9,.26,.5),w);P.position.set(0,1.32,0),It.add(P);let F=new _e(new ot(.85,.06,.45),w);F.position.set(0,1.2,.42),F.rotation.x=.18,It.add(F)}let B=new _e(new kt(.16,.2,1,6),e);B.position.y=-1.05,St.add(B);let G=new _e(new ot(1.1,1.5,.55),a);G.position.y=-2,G.name="torso",St.add(G);{let w=Mt({color:15790326,emissive:3158072}),P=Mt({color:12105924});for(let F=0;F<22;F++){let Y=F/22*Math.PI*2,K=Math.max(0,Math.sin(Y)),ne=-1.2-K*.42,pe=.26+K*.2,ge=new _e(new ot(.15,.09,.07),F%2?w:P);ge.position.set(Math.cos(Y)*pe,ne,Math.sin(Y)*(.26+K*.14)+K*.1),ge.lookAt(0,ne,0),ge.rotation.z+=F%2?.5:-.5,St.add(ge)}}if(Ue.top!=="tee"){let w=new _e(new ot(.34,1.4,.06),Ue.top==="hoodie"?o:Mt({color:14210252}));w.position.set(0,-1.98,.28),St.add(w)}else{let w=new _e(new ot(.6,.5,.03),Mt({map:nn(16,16,F=>{F.fillStyle=Ue.shirt,F.fillRect(0,0,16,16),F.fillStyle="#c8c2b0",F.fillRect(3,3,10,1),F.fillRect(3,6,10,1),F.fillRect(3,9,10,1),F.fillRect(5,12,6,1),F.fillStyle="#8a4a6a",F.fillRect(6,4,4,2)})}));w.position.set(0,-1.95,.28),St.add(w);let P=new _e(new Hn(.28,.05,4,10),o);P.rotation.x=Math.PI/2,P.position.y=-1.26,St.add(P)}if(Ue.top==="hoodie"){let w=new _e(new ot(1.15,.5,.45),a);w.position.set(0,-1.2,-.45),w.rotation.x=.4,St.add(w);let P=Mt({color:14210252});[-1,1].forEach(F=>{let Y=new _e(new ot(.04,.55,.04),P);Y.position.set(F*.22,-1.6,.31),St.add(Y)})}else Ue.top==="sweater"&&[-1,1].forEach(w=>{let P=new _e(new ot(.4,.3,.08),o);P.position.set(w*.28,-1.28,.26),P.rotation.z=w*.6,P.rotation.x=-.25,St.add(P)});[-1,1].forEach(w=>{let P=Ue.top==="tee",F=new _e(new ot(.32,P?.55:1.45,.34),a);if(F.position.set(w*.72,P?-1.55:-2.05,0),F.rotation.z=w*.06,St.add(F),P){let ge=new _e(new ot(.26,.95,.28),e);ge.position.set(w*.74,-2.3,0),St.add(ge)}let Y=new _e(new ot(.22,.28,.24),e);Y.position.set(w*.78,-2.9,0),St.add(Y);let K=new _e(new ot(.42,1.7,.46),Mt({color:1710624}));K.position.set(w*.28,-3.6,0),St.add(K);let ne=new _e(new ot(.4,.26,.62),i);ne.position.set(w*.28,-4.52,.1),St.add(ne);let pe=new _e(new ot(.42,.08,.64),Mt({color:14210252}));pe.position.set(w*.28,-4.63,.1),St.add(pe)});let W=new _e(new ot(1.12,.12,.57),i);W.position.y=-2.75,St.add(W),Ni.add(St)};buildHead();var Nl=document.createElement("canvas");Nl.width=144;Nl.height=240;var Ul=new Ys({canvas:Nl,antialias:!1,alpha:!0});Ul.setPixelRatio(1);Ul.setSize(144,240,!1);Ul.outputColorSpace=Lt;var tu=new Dt(28,144/240,.1,30);tu.position.set(0,-1.7,12);tu.lookAt(0,-2,0);var Ii=zh.getContext("2d",{willReadFrequently:!0}),mf=_v.getContext("2d");function Hv(n){if(!St||!Ui.classList.contains("on")&&!tt("cust").classList.contains("on"))return;let e=Ue.face==="eye"&&n%5.1<.1;if(window.__blinkQuad&&(__blinkQuad.visible=e,__eye.forEach(r=>r.visible=!e)),Ue.face==="grin"&&window.__grinSegs){let r=ts?1:0,a=r?9:2.3,o=window.__grinBase.GY,l=.16+Math.sin(n*1.1)*.03+r*Math.abs(Math.sin(n*a))*.07,c=Math.sin(n*.7)*.012+r*Math.sin(n*a*.6)*.018,u=d=>{let h=Math.sin(d*Math.PI)*.022,f=Math.pow(Math.max(0,d-.55)/.45,1.4)*l,g=Math.sin(n*a+d*11)*.006*(.35+r);return o-h+f+g+c*(d-.5)};window.__grinSegs.forEach(d=>{d.mesh.position.y=u(d.t)}),window.__grinTeeth.forEach(d=>{d.mesh.position.y=u(d.t)}),window.__grinDivs.forEach(d=>{d.mesh.position.y=u(d.t)}),window.__brows&&window.__brows.forEach(d=>{let h=r?Math.sin(n*a+d.side*1.2+d.k*.5)*.018:Math.sin(n*1.4+d.side)*.006;d.mesh.position.y=d.by+h})}It.rotation.y=Math.sin(n*.8)*.1+(ts?Math.sin(n*14)*.03:0),It.rotation.z=Math.sin(n*.6)*.06+(ts?Math.sin(n*11)*.04:0),It.rotation.x=ts?Math.sin(n*9)*.03:0,It.position.y=Math.sin(n*2.2)*.03+(ts?Math.abs(Math.sin(n*12))*.04:0);let t=tt("cust").classList.contains("on");if(St.rotation.y=t?Math.sin(n*.5)*.9:Math.sin(n*.6)*.06,Dl.render(Ni,eu),Ii.clearRect(0,0,200,200),ts){Ii.drawImage(ns,0,0);let r=80,a=128,o=42,l=18,c=a;for(;c<a+l;){let d=3+(Math.random()*5|0),h=Math.random()*10-5|0;Ii.drawImage(ns,r,c,o,d,r+h,c,o,d),c+=d}let u=2+(Math.random()*3|0);for(let d=0;d<u;d++){let h=4+(Math.random()*10|0),f=3+(Math.random()*6|0);Ii.clearRect(r+(Math.random()*(o-h)|0),a+(Math.random()*(l-f)|0),h,f)}for(let d=0;d<2;d++){let h=5+(Math.random()*6|0),f=r+(Math.random()*(o-h)|0),g=a+(Math.random()*(l-h)|0);Ii.drawImage(ns,f,g,h,h,f+(Math.random()*12-6|0),g+(Math.random()*6-3|0),h,h)}}else Ii.drawImage(ns,0,0);let i=Ii.getImageData(0,0,200,200),s=i.data;for(let r=0;r<s.length;r+=4)s[r+3]&&(s[r]=Math.round(s[r]/8)*8,s[r+1]=Math.round(s[r+1]/8)*8,s[r+2]=Math.round(s[r+2]/8)*8);Ii.putImageData(i,0,0),t&&(Ul.render(Ni,tu),mf.clearRect(0,0,144,240),mf.drawImage(Nl,0,0))}na();var Dh=0,$r=0,Sh=0,bh=0,Li=0,Di=0,Eh=62,nu=62,Kr=1.05,Nh=.45,Uh=.55;function Yf(n,e){Dh=n/innerWidth*2-1,$r=e/innerHeight*2-1,sn||(Li=-Dh*Kr,Di=$r<0?-$r*Nh:-$r*Uh)}var iu=!1,Fh=0,Oh=0,ls=localStorage.getItem("azal.look")||"mouse",Vv=tt("mode");function ta(){Vv.textContent=ls==="mouse"?"LOOK: MOUSE POSITION  [L]":"LOOK: POV"+(document.pointerLockElement?"  \xB7  ESC TO RELEASE":"  \xB7  CLICK TO GRAB")+"  [L]"}ta();Fl();function Gv(n){ls=n,localStorage.setItem("azal.look",n),n==="pov"?sn||ea.requestPointerLock?.():document.pointerLockElement&&document.exitPointerLock(),ta(),Fl()}addEventListener("keydown",n=>{(n.key==="l"||n.key==="L")&&Gv(ls==="mouse"?"pov":"mouse")});function Fl(){if(sn)return;let n=!!document.pointerLockElement,e=ls==="pov";document.body.style.cursor=e&&!n?"grab":"none",tt("dot").style.opacity=e&&!n?0:.9}document.addEventListener("pointerlockchange",()=>{ta(),Fl()});ea.addEventListener("pointerdown",()=>{ls==="pov"&&!document.pointerLockElement&&!sn&&ea.requestPointerLock?.()});addEventListener("pointermove",n=>{if(ls==="pov"){document.pointerLockElement&&!sn&&(Li=Ws.clamp(Li-n.movementX*.0022,-Kr,Kr),Di=Ws.clamp(Di-n.movementY*.0022,-Uh,Nh));return}matchMedia("(pointer:fine)").matches&&!n.buttons?Yf(n.clientX,n.clientY):iu&&(Li+=(n.clientX-Fh)*.004,Di+=(n.clientY-Oh)*.003,Li=Ws.clamp(Li,-Kr,Kr),Di=Ws.clamp(Di,-Uh,Nh),Fh=n.clientX,Oh=n.clientY)});addEventListener("pointerdown",n=>{iu=!0,Fh=n.clientX,Oh=n.clientY});addEventListener("pointerup",()=>iu=!1);var Th=new Ur,Wv=new ue(0,0),gn=null,wh=tt("label"),fl=tt("dot"),Zf=new $t({color:6094726,transparent:!0,opacity:0,depthWrite:!1,blending:$i,side:Nt}),Jf=new $t({color:2783806,transparent:!0,opacity:.18,depthWrite:!1,blending:$i,side:Nt}),$f=new Map;ss.forEach(n=>{let e=n.parent.children[0],t=new _e(e.geometry,Jf.clone());t.scale.set(1.04,1.05,1.04),t.renderOrder=2,e.parent.add(t),$f.set(n,t)});function Bh(n,e){let t=$f.get(n);t&&(t.material=e?Zf:Jf.clone(),t.scale.setScalar(e?1.07:1.045))}var pl=0,gf=localStorage.getItem("azal.pillsaid")==="1",Ah=0;function Xv(){if(Th.setFromCamera(Wv,Cn),!gf&&!Ui.classList.contains("on")){let t=performance.now()/1e3,i=Ah?Math.min(t-Ah,.1):0;Ah=t,pl=Th.intersectObjects(Uv,!1).length>0?pl+i:Math.max(0,pl-i*2),pl>10&&(gf=!0,localStorage.setItem("azal.pillsaid","1"),kh([si.pills||"..."]))}let n=Th.intersectObjects(ss,!1)[0],e=n?n.object:null;e!==gn&&(gn&&(gn.material.map=gn.userData.cold,gn.material.needsUpdate=!0,Bh(gn,!1)),gn=e,e?(e.material.map=e.userData.hot,e.material.needsUpdate=!0,Bh(e,!0),wh.textContent="[ "+e.userData.section.title.toUpperCase()+" ]",wh.style.opacity=1,fl.style.transform="scale(1.8)",fl.style.background="#8ef59a"):(wh.style.opacity=0,fl.style.transform="",fl.style.background="#fff"))}var wl=Rl.clone(),ml=Rl.clone();function su(n){let e=new D;n.getWorldPosition(e);let t=new D(0,0,1).applyQuaternion(n.parent.getWorldQuaternion(new yn)),i=innerWidth<700?.95:1.15;wl.copy(e).addScaledVector(t,i);let s=e.clone().sub(wl);Li=Math.atan2(-s.x,-s.z),Di=Math.atan2(s.y,Math.hypot(s.x,s.z)),nu=40}Ln=new Us(ia);Ln.magFilter=Ln.minFilter=Ct;Ln.colorSpace=Lt;ea.addEventListener("click",()=>{sn||gn&&(su(gn),Gh(gn.userData.section))});var qv=is;is=function(){qv(),nu=62,wl.copy(Rl),ls==="mouse"&&Yf(innerWidth/2+Dh*innerWidth/2,innerHeight/2+$r*innerHeight/2)};tt("bClose").onclick=()=>is();var _f=!1;function ru(){_f||(_f=!0,setTimeout(()=>kh((si.intro||["Hey. I'm {name}."]).map(n=>n.replace(/\{name\}/g,Ue.name))),600))}addEventListener("pointerdown",ru,{once:!0});addEventListener("keydown",ru,{once:!0});setTimeout(ru,2500);var xf=!0;function Kf(){let n=performance.now()/1e3;if(xf){xf=!1;let e=tt("loading");e&&requestAnimationFrame(()=>e.classList.add("off"))}if(Sh+=(Li-Sh)*.08,bh+=(Di-bh)*.08,Eh+=(nu-Eh)*.08,Cn.fov=Eh,Cn.updateProjectionMatrix(),ml.lerp(wl,.08),Cn.position.set(ml.x+Math.sin(n*.7)*.006,ml.y+Math.sin(n*1.3)*.008,ml.z),Cn.rotation.set(0,0,0,"YXZ"),Cn.rotation.y=Sh,Cn.rotation.x=bh,El.intensity=13+Math.sin(n*9)*.6+(Math.random()<.02?-4:0),jh.intensity=5.5+Math.sin(n*20)*.5,Zf.opacity=.35+Math.sin(n*6)*.2,gn){let e=new D;gn.getWorldPosition(e),vl.position.copy(e).add(new D(0,0,.6)),vl.intensity=6+Math.sin(n*6)*2}else vl.intensity=0;Kh.material.color.setHSL(.1,.7,El.intensity>10?.85:.5),sn||Xv(),sa.render(ht,Cn),Hv(n),requestAnimationFrame(Kf)}document.fonts.ready.then(()=>{ss.forEach(n=>{let e=n.userData.section;n.userData.cold=bl(e.tv,e.title.toUpperCase(),!1),n.userData.hot=bl(e.tv,"> OPEN",!0),n.material.map=n===gn?n.userData.hot:n.userData.cold,n.material.needsUpdate=!0})});Kf();window.__room={get active(){return sn},openSection:Gh,closeSection:is,screens:ss,SECTIONS:$s,setPage:jr,channel:Qr,aimAt:su,get pages(){return qn},get page(){return Dn}};window.addEventListener("error",n=>{window.__lastErr=(n.message||"")+" @"+(n.filename||"").split("/").pop()+":"+n.lineno});
